...
import { a as _extends, B as _isFunction, _ as _objectWithoutProperties, d as _slicedToArray, m as makeWidthStyle, p as passRest, g as _omit, u as classNames, s as _defineProperty, A as styleInject, I as I18N, l as lfLog, c as _isEmpty } from './index-DjkwpNX_.js';
import React__default, { useState, useCallback } from 'react';
import { F as Form } from './Form-CRp2qAAw.js';
import { B as Button } from './Button-BvWeq9tR.js';
import './createWithBsPrefix-cMuRGYJR.js';
import 'prop-types';
import './Button-DPLXCUoJ.js';

var _excluded$1 = ["ButtonComponent", "OnStateProps", "OffStateProps", "LinkProps", "name", "labelOn", "labelOff", "labelLink", "iconOn", "iconOff", "iconLink", "size", "href", "appearance", "fullWidth", "width", "onChange", "onBlur", "value", "buttonType", "hint", "initialValue"];
var GenericButton = function GenericButton(_ref) {
  ...
  if (buttonType === 'toggle') {
    inner = /*#__PURE__*/React__default.createElement(ButtonComponent, _extends({
      size: size,
      onClick: handleClick,
      onBlur: onBlur,
...
var MakeButton = function MakeButton(ButtonComponent, OnStateProps, OffStateProps, LinkProps) {
  return function (props) {
    return /*#__PURE__*/React__default.createElement(GenericButton, _extends({
