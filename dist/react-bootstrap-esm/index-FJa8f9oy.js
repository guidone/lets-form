...
var Fields = {
  'input-text': {
    'react-bootstrap': lazyPreload(function () {
      return import('./index-CQ76hE7l.js');
    })
  },
  'select': {
    'react-bootstrap': lazyPreload(function () {
      return import('./index-DanyjWCs.js');
    })
  },
  'checkbox': {
    'react-bootstrap': lazyPreload(function () {
      return import('./index-CqUv7D86.js');
    })
  },
  'toggle': {
    'react-bootstrap': lazyPreload(function () {
      return import('./index-CIMTDTrs.js');
    })
  },
  'checkbox-group': {
    'react-bootstrap': lazyPreload(function () {
      return import('./index-B1wpy3SC.js');
    })
  },
  'placeholder': {
    'react-bootstrap': lazyPreload(function () {
      return import('./index-Blpf_suA.js');
    })
  },
  'placeholder-image': {
    'react-bootstrap': lazyPreload(function () {
      return import('./index-DEkZKPLM.js');
    })
  },
  'date': {
    'react-bootstrap': lazyPreload(function () {
      return import('./index-D1GjCLTX.js');
    })
  },
  'textarea': {
    'react-bootstrap': lazyPreload(function () {
      return import('./index-Dwd5wwVt.js');
    })
  },
  'slider': {
    'react-bootstrap': lazyPreload(function () {
      return import('./index-B02b6gJC.js');
    })
  },
  'three-columns': {
    'react-bootstrap': lazyPreload(function () {
      return import('./index-spgT76M1.js');
    })
  },
  'two-columns': {
    'react-bootstrap': lazyPreload(function () {
      return import('./index-DeODLQfA.js');
    })
  },
  'group': {
    'react-bootstrap': lazyPreload(function () {
      return import('./index-CgEoPG1t.js');
    })
  },
  'radio-group': {
    'react-bootstrap': lazyPreload(function () {
      return import('./index-B8P8MUF0.js');
    })
  },
  'divider': {
    'react-bootstrap': lazyPreload(function () {
      return import('./index-CHUKgm10.js');
    })
  },
  'react-view': {
    'react-bootstrap': lazyPreload(function () {
      return import('./index-BsuHxP4Z.js');
    })
  },
  'datetime': {
    'react-bootstrap': lazyPreload(function () {
      return import('./index-NLSN8HA6.js');
    })
  },
  'array': {
    'react-bootstrap': lazyPreload(function () {
      return import('./index-DlTt1Rbx.js');
    })
  },
  'input-number': {
    'react-bootstrap': lazyPreload(function () {
      return import('./index-B0-JbaoB.js');
    })
  },
  'tabs': {
    'react-bootstrap': lazyPreload(function () {
      return import('./index-BQP348Eh.js');
    })
  },
  'button': {
    'react-bootstrap': lazyPreload(function () {
      return import('./index-BQEoyn-9.js');
    })
  },
  'hidden': {
    'react-bootstrap': lazyPreload(function () {
      return import('./index-C7g6mmze.js');
    })
  }
};
var Forms = {
  'react-bootstrap': lazyPreload(function () {
    return import('./index-BTVr7bwI.js');
  })
};
