/* LetsForm react-rsuite5 v0.7.18 - ESM */
...
var Fields = {
  'input-text': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-BZXGQ4DM.js');
    })
  },
  'toggle': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-BYIaNVg2.js');
    })
  },
  'select': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-xg1qXak5.js');
    })
  },
  'group': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-Dsf8gbdQ.js');
    })
  },
  'array': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-BrQKAu6z.js');
    })
  },
  'two-columns': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-DPXwqLrG.js');
    })
  },
  'three-columns': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-DxaO71fd.js');
    })
  },
  'input-number': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-DBz7xF6q.js');
    })
  },
  'date': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-Brki9H3a.js');
    })
  },
  'checkbox': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-BU-JZWlP.js');
    })
  },
  'checkbox-group': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-BBDcA5ND.js');
    })
  },
  'slider': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-BmnRw9Ol.js');
    })
  },
  'radio-group': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-BGcGvoMv.js');
    })
  },
  'input-tag': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-kpoPhKqm.js');
    })
  },
  'input-mask': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-DtywMgjz.js');
    })
  },
  'textarea': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-C_66NjMt.js');
    })
  },
  'rate': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-BRKIqWL9.js');
    })
  },
  'placeholder': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-13UO9YuL.js');
    })
  },
  'multiselect': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-CdD0-Vx_.js');
    })
  },
  'multiselect-language': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-LC1k8Lcp.js');
    })
  },
  'input-text-i18n': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-BTxf2nHC.js');
    })
  },
  'placeholder-image': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-D0W8iptZ.js');
    })
  },
  'button': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-C8zY9Inc.js');
    })
  },
  'divider': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-DGNmaI_h.js');
    })
  },
  'react-view': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-ZJqGtvdy.js');
    })
  },
  'datetime': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-CJTTPv5c.js');
    })
  },
  'tabs': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-Cti2wpB_.js');
    })
  },
  'radio-tile': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-B7Y4C1fV.js');
    })
  },
  'upload': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-ChpDxbcI.js');
    })
  },
  'buttons-toggle-group': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-C0mnyDKo.js');
    })
  },
  'steps': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-leQwEmRQ.js');
    })
  },
  'esm-module': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-Do1Yae6w.js');
    })
  },
  'time': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-C35GlYfS.js');
    })
  },
  'hidden': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-DCho_aOj.js');
    })
  }
};
var Forms = {
  'react-rsuite5': lazyPreload(function () {
    return import('./index-KZDLhaTE.js');
  })
};
...
export { isValidDayjsFormat as $, isValidDate as A, _isObject as B, _objectSpread2 as C, LOCALES as D, isI18n as E, FormContext as F, Group as G, isUrl as H, I18N as I, _isFunction as J, isValidTime as K, LetsForm as L, Fields as M, Forms as N, replaceField as O, mapFields as P, deleteField as Q, cleanUp as R, addField as S, TwoColumns as T, findField as U, createEmptyField as V, reduceFields as W, getFieldById as X, applyFormRules as Y, validateRulesDefinition as Z, _isString as _, _objectWithoutProperties as a, filterFields as a0, getLocales as a1, i18n as a2, isEmptyForm as a3, applyTransformers as a4, formHelper as a5, collectIds as a6, isChildrenOf as a7, validateJSONForm as a8, formHasComponents as a9, omitFields as aa, FRAMEWORKS as ab, FRAMEWORKS_LABELS as ac, FIELDS_KEY as ad, _extends as b, _castSlice as c, _hasUnicode as d, _stringToArray as e, filterOptions as f, getDefaultExportFromCjs as g, _isNumber as h, i18nOptions as i, _defineProperty$1 as j, classNames as k, lfLog as l, makeWidthStyle as m, _slicedToArray as n, _toConsumableArray as o, passRest as p, _isArray as q, _omit as r, styleInject as s, toString_1 as t, useFormContext as u, collectNames as v, _isEmpty as w, fillIds as x, ThreeColumns as y, _isDate as z };
