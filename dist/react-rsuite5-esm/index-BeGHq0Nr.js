...
import { s as styleInject, I as I18N, l as lfLog, _ as _objectWithoutProperties, a as _extends, m as makeClassName, c as makeWidthStyle, b as _isString, f as filterOptions, p as passRest, i as i18nOptions } from './index-B3an8oBE.js';
import React from 'react';
import { Form, SelectPicker } from 'rsuite';
import { R as RequiredIcon } from './index-DLjT-AHU.js';
import { R as RSuite5FieldControl } from './index-CAn1fKef.js';

var css_248z = ".lf-control-select-option-rsuite5 img {\n  width: 20px;\n  max-width: 20px;\n  max-height: 20px;\n  margin-right: 6px;\n  margin-top: -4px;\n  display: inline-block;\n}";
styleInject(css_248z);

var _excluded = ["name", "label", "hint", "value", "size", "placeholder", "lfLocale", "options", "tooltip", "disabled", "readOnly", "required", "error", "block", "searchable", "cleanable", "onChange", "onBlur", "placement", "appearance", "filterKey", "filterValue", "showImageOptions", "fullWidth", "width", "className"];
...
var Select = I18N(function (_ref) {
  ...
  return /*#__PURE__*/React.createElement(Form.Group, _extends({}, makeClassName('select', name, className), {
    controlId: name,
