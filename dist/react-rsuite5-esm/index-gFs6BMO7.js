...
import { d as _castSlice, e as _hasUnicode, g as _stringToArray, t as toString_1, h as getDefaultExportFromCjs, j as _isNumber, k as _defineProperty, n as classNames, u as useFormContext, o as _slicedToArray, q as _toConsumableArray, r as _isArray, v as _omit, b as _isString, w as collectNames, x as _isEmpty, y as fillIds, s as styleInject, I as I18N, l as lfLog, _ as _objectWithoutProperties, m as makeClassName, a as _extends, L as LetsForm } from './index-BC40JkIQ.js';
...
var ListArrayRSuite5 = I18N(function (_ref) {
  ...
  return /*#__PURE__*/React.createElement(Form.Group, makeClassName('array', name, className), label && /*#__PURE__*/React.createElement(Form.ControlLabel, null, label, hint && tooltip && /*#__PURE__*/React.createElement(Form.HelpText, {
    ...
    name: name
  }, rest)), _isString((_rest$error = rest.error) === null || _rest$error === void 0 ? void 0 : _rest$error.errorMessage) && /*#__PURE__*/React.createElement(Form.HelpText, {
