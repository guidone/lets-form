...
import { s as styleInject$1, z as _typeof$1, I as I18N$1, l as lfLog$1, a as _objectWithoutProperties$1, n as _slicedToArray$1, _ as _isString$1, k as classNames$1, j as _defineProperty$2, m as makeWidthStyle$1, b as _extends$1 } from './index-eOrnPMH8.js';
import React$1, { createContext, useState, useCallback, useEffect, Suspense, forwardRef, useRef, createElement, useContext, lazy } from 'react';
...
var Fields = {
  'input-text': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-BhD8zewT-eAPaqxjG.js');
    })
  },
  'toggle': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-DvMy4JDx-CJtR-woC.js');
    })
  },
  'select': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-CXgy06wj-DCS0mTf8.js');
    })
  },
  'group': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-B2_7-aL--Cgw6Fze9.js');
    })
  },
  'array': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-C8oMSLI--Dsqcyx93.js');
    })
  },
  'two-columns': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-DUa-qaDh-ClT_LjHs.js');
    })
  },
  'three-columns': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-DGyXswhB-BqtEEDsx.js');
    })
  },
  'input-number': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-D-Uuoaz--DCVj7eBo.js');
    })
  },
  'date': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-CiI9PuzA-qNFzwmVy.js');
    })
  },
  'checkbox': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-9wT45c1i-BiKj1NO3.js');
    })
  },
  'checkbox-group': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-DR-_sZ3U-DvIGO1ux.js');
    })
  },
  'slider': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-DpSZs66L-CHe78L08.js');
    })
  },
  'radio-group': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-DsVAyL8h-B-WUnipG.js');
    })
  },
  'input-tag': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-W-flu2xN-DKCeZNcK.js');
    })
  },
  'input-mask': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-DZol-nQu-B8TJHxch.js');
    })
  },
  'textarea': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-C26GBjjU-4yFBLm8w.js');
    })
  },
  'rate': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-Do7LDhw8-BTlD0VSw.js');
    })
  },
  'placeholder': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-B7-QtJAq-DnqSR7BU.js');
    })
  },
  'multiselect': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-Q2x3bK6S-Cu20B9ZF.js');
    })
  },
  'multiselect-language': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-Br3EO37u-C8hnryu-.js');
    })
  },
  'input-text-i18n': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-B6WwCAgc-SNItGpnZ.js');
    })
  },
  'placeholder-image': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-B9XaxKJc-BP0KoYuI.js');
    })
  },
  'button': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-Cl7vYw_A-BFcFSMgJ.js');
    })
  },
  'divider': {
    'react-rsuite5': lazyPreload(function () {
  ...
  'react-view': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-CkpW35Se-BcsqAizi.js');
    })
  },
  'datetime': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-C0-ufJaE-BLmTT_Lx.js');
    })
  },
  'tabs': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-CrgRncR8-Dbh5xbcw.js');
    })
  },
  'radio-tile': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-CkIe0W_R-CW8D-Q9K.js');
    })
  },
  'upload': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-DmSbf8r_-BCD6-xpU.js');
    })
  },
  'buttons-toggle-group': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-BPALsf62-CPO_9tYi.js');
    })
  },
  'steps': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-BXgGKaaF-BgrOxD3y.js');
    })
  },
  'esm-module': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-DVcvdwLI-C1gugh8X.js');
    })
  },
  'time': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-g5p-FoIt-BmnpJiLO.js');
    })
  },
  'hidden': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-Rx7wfO6x-BZomaxbz.js');
    })
  }
};
var Forms = {
  'react-rsuite5': lazyPreload(function () {
    return import('./index-LahFDBZm-DRS0LBDC.js');
  })
};
