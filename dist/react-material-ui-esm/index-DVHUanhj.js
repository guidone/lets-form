/* LetsForm react-material-ui v0.7.16 - ESM */
...
var Fields = {
  'input-text': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-BiVYA7NK.js');
    })
  },
  'select': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-D4uq-NBW.js');
    })
  },
  'toggle': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-Dl6-oOPm.js');
    })
  },
  'checkbox': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-Dpx1bB2e.js');
    })
  },
  'slider': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-CJxAJS66.js');
    })
  },
  'placeholder': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-BtEuQD7X.js');
    })
  },
  'rate': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-CV9c2UXd.js');
    })
  },
  'date': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-vNkpc9XF.js');
    })
  },
  'three-columns': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-Kg2dEHij.js');
    })
  },
  'two-columns': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-NbSPlpxQ.js');
    })
  },
  'group': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-Csc1yY4D.js');
    })
  },
  'placeholder-image': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-BLU0mQKm.js');
    })
  },
  'divider': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-iBqLJQP3.js');
    })
  },
  'react-view': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-zg9KP7VQ.js');
    })
  },
  'datetime': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DQeqNOPK.js');
    })
  },
  'array': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-bWt1iKfQ.js');
    })
  },
  'textarea': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DHzUKh7w.js');
    })
  },
  'multiselect': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-BZ6XNXyw.js');
    })
  },
  'input-number': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-B1gmxXhW.js');
    })
  },
  'radio-group': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DKI4pLY5.js');
    })
  },
  'checkbox-group': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-8lyZeNfQ.js');
    })
  },
  'tabs': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-S2TCDhJv.js');
    })
  },
  'button': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-BNa3LxaO.js');
    })
  },
  'upload': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-ReHB1QD0.js');
    })
  }
};
var Forms = {
  'react-material-ui': lazyPreload(function () {
    return import('./index-PX1EQDJn.js');
  })
};
...
export { getLocales as $, fillIds as A, styleInject as B, _objectDestructuringEmpty as C, filterOptions as D, isUrl as E, _isFunction as F, Group as G, makeWidthStyle as H, I18N as I, _isObject as J, Fields as K, LetsForm as L, Forms as M, replaceField as N, mapFields as O, deleteField as P, cleanUp as Q, addField as R, findField as S, ThreeColumns as T, createEmptyField as U, reduceFields as V, getFieldById as W, applyFormRules as X, validateRulesDefinition as Y, filterFields as Z, _objectWithoutProperties as _, _extends as a, i18n as a0, isEmptyForm as a1, isI18n as a2, applyTransformers as a3, formHelper as a4, collectIds as a5, isChildrenOf as a6, validateJSONForm as a7, formHasComponents as a8, FRAMEWORKS as a9, FRAMEWORKS_LABELS as aa, FIELDS_KEY as ab, _isNumber as b, _objectSpread2 as c, _isEmpty as d, _isDate as e, _isString as f, isValidDate as g, TwoColumns as h, i18nOptions as i, commonjsGlobal as j, getDefaultExportFromCjs as k, lfLog as l, isValidDayjsFormat as m, _castSlice as n, _hasUnicode as o, passRest as p, _stringToArray as q, _defineProperty$1 as r, classNames as s, toString_1 as t, useFormContext as u, _slicedToArray as v, _toConsumableArray as w, _isArray as x, _omit as y, collectNames as z };
