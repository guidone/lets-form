/* LetsForm react-material-ui v0.11.5 - ESM */
...
var Fields = {
  'input-text': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-CAtO_GUW.js');
    })
  },
  'select': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-B9bJlTr5.js');
    })
  },
  'toggle': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-BzMfwfEn.js');
    })
  },
  'checkbox': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-BfM5KMvN.js');
    })
  },
  'slider': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-C5Tt91Za.js');
    })
  },
  'placeholder': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-CQYUIyPB.js');
    })
  },
  'rate': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-zPnDroky.js');
    })
  },
  'date': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-BhKAh4MB.js');
    })
  },
  'three-columns': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DnEk7mVc.js');
    })
  },
  'two-columns': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-0mXAQYiq.js');
    })
  },
  'columns': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-D448Xz75.js');
    })
  },
  'group': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-Py9IO1JP.js');
    })
  },
  'placeholder-image': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-B-dGhr1H.js');
    })
  },
  'divider': {
    'react-material-ui': lazyPreload(function () {
  ...
  'react-view': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-D8X4rn9O.js');
    })
  },
  'datetime': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DQiCV2FV.js');
    })
  },
  'array': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-D8D2490d.js');
    })
  },
  'textarea': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-CUJH85DP.js');
    })
  },
  'multiselect': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-CMtUHYYr.js');
    })
  },
  'input-number': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-BBTa0LxB.js');
    })
  },
  'radio-group': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-g3_1_VLv.js');
    })
  },
  'checkbox-group': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-CsH7wGRx.js');
    })
  },
  'tabs': {
    'react-material-ui': lazyPreload(function () {
      return import('./index--RnJX3Do.js');
    })
  },
  'button': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-hiXBdbo8.js');
    })
  },
  'upload': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-CrpcedZ2.js');
    })
  },
  'time': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-x6CvGS54.js');
    })
  },
  'hidden': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-C-YiI39o.js');
    })
  }
};
var Forms = {
  'react-material-ui': lazyPreload(function () {
    return import('./index-Da3RIMZO.js');
  })
};
...
export { applyFormRules as $, fillIds as A, styleInject as B, Columns as C, filterOptions as D, isUrl as E, _isFunction as F, Group as G, _isObject as H, I18N as I, isValidTime as J, commonjsGlobal as K, LetsForm as L, Fields as M, Forms as N, Connectors as O, replaceField as P, mapFields as Q, deleteField as R, cleanUp as S, ThreeColumns as T, addField as U, AddFieldAfter as V, findField as W, createEmptyField as X, reduceFields as Y, getFieldById as Z, _objectWithoutProperties as _, _extends as a, filterFields as a0, getLocales as a1, i18n as a2, isEmptyForm as a3, isI18n as a4, applyTransformers as a5, formHelper as a6, collectIds as a7, isChildrenOf as a8, isValidConnector as a9, isValidForm as aa, isValidField as ab, isValidArrayOfFields as ac, validateJSONForm as ad, formHasComponents as ae, omitFields as af, FRAMEWORKS as ag, FRAMEWORKS_LABELS as ah, FIELDS_KEY as ai, LfField as aj, LfGroup as ak, LfColumns as al, LfColumn as am, LfArray as an, LfTabs as ao, LfTab as ap, LfSteps as aq, LfStep as ar, traverseChildren as as, _isNumber as b, _objectSpread2 as c, _isEmpty as d, _isDate as e, _isString as f, isValidDate as g, TwoColumns as h, i18nOptions as i, isValidDayjsFormat as j, _castSlice as k, lfLog as l, makeWidthStyle as m, _hasUnicode as n, _stringToArray as o, passRest as p, getDefaultExportFromCjs as q, _defineProperty$1 as r, classNames as s, toString_1 as t, useFormContext as u, _slicedToArray as v, _toConsumableArray as w, _isArray as x, _omit as y, collectNames as z };
