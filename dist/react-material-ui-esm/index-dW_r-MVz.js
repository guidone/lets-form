/* LetsForm react-material-ui v0.10.5 - ESM */
...
var Fields = {
  'input-text': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DmSatsdl.js');
    })
  },
  'select': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-VEYynwTr.js');
    })
  },
  'toggle': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-CNRyWXkh.js');
    })
  },
  'checkbox': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-eLZ3liU_.js');
    })
  },
  'slider': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DHR86Fg1.js');
    })
  },
  'placeholder': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DVoW-Jc_.js');
    })
  },
  'rate': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-CF6RsUmI.js');
    })
  },
  'date': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-C8K7fzxv.js');
    })
  },
  'three-columns': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-BUpiMILg.js');
    })
  },
  'two-columns': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-CqH52kPd.js');
    })
  },
  'columns': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-Ct_kqMBD.js');
    })
  },
  'group': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-C_Dm-muP.js');
    })
  },
  'placeholder-image': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-K2n7z0p_.js');
    })
  },
  'divider': {
    'react-material-ui': lazyPreload(function () {
  ...
  'react-view': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DHkHLMPV.js');
    })
  },
  'datetime': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-IR5u5pCN.js');
    })
  },
  'array': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-oUHJy_T0.js');
    })
  },
  'textarea': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-BVhNNXD9.js');
    })
  },
  'multiselect': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-CFiT3I6T.js');
    })
  },
  'input-number': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-CeMhQc-8.js');
    })
  },
  'radio-group': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DSI6Dovy.js');
    })
  },
  'checkbox-group': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-BW1C5_Zh.js');
    })
  },
  'tabs': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-BNgtFv7V.js');
    })
  },
  'button': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-Df_CTBfO.js');
    })
  },
  'upload': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-_edsQbfj.js');
    })
  },
  'time': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-D65RpWgN.js');
    })
  },
  'hidden': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DIQru4gV.js');
    })
  }
};
var Forms = {
  'react-material-ui': lazyPreload(function () {
    return import('./index-WlYOHWOC.js');
  })
};
...
export { filterFields as $, fillIds as A, styleInject as B, Columns as C, filterOptions as D, isUrl as E, _isFunction as F, Group as G, _isObject as H, I18N as I, isValidTime as J, commonjsGlobal as K, LetsForm as L, Fields as M, Forms as N, Connectors as O, replaceField as P, mapFields as Q, deleteField as R, cleanUp as S, ThreeColumns as T, addField as U, findField as V, createEmptyField as W, reduceFields as X, getFieldById as Y, applyFormRules as Z, _objectWithoutProperties as _, _extends as a, getLocales as a0, i18n as a1, isEmptyForm as a2, isI18n as a3, applyTransformers as a4, formHelper as a5, collectIds as a6, isChildrenOf as a7, isValidConnector as a8, isValidForm as a9, isValidField as aa, isValidArrayOfFields as ab, validateJSONForm as ac, formHasComponents as ad, omitFields as ae, FRAMEWORKS as af, FRAMEWORKS_LABELS as ag, FIELDS_KEY as ah, LfField as ai, LfGroup as aj, LfColumns as ak, LfColumn as al, LfArray as am, LfTabs as an, LfTab as ao, LfSteps as ap, LfStep as aq, traverseChildren as ar, _isNumber as b, _objectSpread2 as c, _isEmpty as d, _isDate as e, _isString as f, isValidDate as g, TwoColumns as h, i18nOptions as i, isValidDayjsFormat as j, _castSlice as k, lfLog as l, makeWidthStyle as m, _hasUnicode as n, _stringToArray as o, passRest as p, getDefaultExportFromCjs as q, _defineProperty$1 as r, classNames as s, toString_1 as t, useFormContext as u, _slicedToArray as v, _toConsumableArray as w, _isArray as x, _omit as y, collectNames as z };
