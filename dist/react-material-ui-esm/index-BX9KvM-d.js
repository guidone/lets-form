/* LetsForm react-material-ui v0.9.4 - ESM */
...
var Fields = {
  'input-text': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-mmhO-yhB.js');
    })
  },
  'select': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-BJJuBQzl.js');
    })
  },
  'toggle': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DY2jh9P6.js');
    })
  },
  'checkbox': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-CmnavJ6z.js');
    })
  },
  'slider': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-CV50OUov.js');
    })
  },
  'placeholder': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-BmxSZcQ_.js');
    })
  },
  'rate': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DuWT-hIf.js');
    })
  },
  'date': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-CtGjKwMu.js');
    })
  },
  'three-columns': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DEeLri6f.js');
    })
  },
  'two-columns': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-oXOtk4Rs.js');
    })
  },
  'group': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-g6XcJO6W.js');
    })
  },
  'placeholder-image': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DJpJs52x.js');
    })
  },
  'divider': {
    'react-material-ui': lazyPreload(function () {
  ...
  'react-view': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-9wv262d1.js');
    })
  },
  'datetime': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DPURSbUS.js');
    })
  },
  'array': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-PYvUfvWt.js');
    })
  },
  'textarea': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-CHw_a4pb.js');
    })
  },
  'multiselect': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-kHqZzJeB.js');
    })
  },
  'input-number': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-Bj6vAQy5.js');
    })
  },
  'radio-group': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-CS6t4Ry8.js');
    })
  },
  'checkbox-group': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-JgIwTx7d.js');
    })
  },
  'tabs': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-BbgFXoon.js');
    })
  },
  'button': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-lKM6dR1a.js');
    })
  },
  'upload': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-BhPXt7nK.js');
    })
  },
  'time': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DIxhDVzQ.js');
    })
  },
  'hidden': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-B-wq2m-I.js');
    })
  }
};
var Forms = {
  'react-material-ui': lazyPreload(function () {
    return import('./index-CywpHhzm.js');
  })
};
...
export { getLocales as $, fillIds as A, styleInject as B, filterOptions as C, isUrl as D, _isFunction as E, _isObject as F, Group as G, isValidTime as H, I18N as I, commonjsGlobal as J, Fields as K, LetsForm as L, Forms as M, Connectors as N, replaceField as O, mapFields as P, deleteField as Q, cleanUp as R, addField as S, ThreeColumns as T, findField as U, createEmptyField as V, reduceFields as W, getFieldById as X, applyFormRules as Y, filterFields as Z, _objectWithoutProperties as _, _extends as a, i18n as a0, isEmptyForm as a1, isI18n as a2, applyTransformers as a3, formHelper as a4, collectIds as a5, isChildrenOf as a6, isValidConnector as a7, isValidForm as a8, isValidField as a9, isValidArrayOfFields as aa, validateJSONForm as ab, formHasComponents as ac, omitFields as ad, FRAMEWORKS as ae, FRAMEWORKS_LABELS as af, FIELDS_KEY as ag, LfField as ah, LfGroup as ai, LfColumns as aj, LfColumn as ak, LfArray as al, LfTabs as am, LfTab as an, LfSteps as ao, LfStep as ap, traverseChildren as aq, _isNumber as b, _objectSpread2 as c, _isEmpty as d, _isDate as e, _isString as f, isValidDate as g, TwoColumns as h, i18nOptions as i, isValidDayjsFormat as j, _castSlice as k, lfLog as l, makeWidthStyle as m, _hasUnicode as n, _stringToArray as o, passRest as p, getDefaultExportFromCjs as q, _defineProperty$1 as r, classNames as s, toString_1 as t, useFormContext as u, _slicedToArray as v, _toConsumableArray as w, _isArray as x, _omit as y, collectNames as z };
