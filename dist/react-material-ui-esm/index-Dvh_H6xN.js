/* LetsForm react-material-ui v0.12.3 - ESM */
...
var Fields = {
  'input-text': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-D0GAyPcR.js');
    })
  },
  'select': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DRmR4VfS.js');
    })
  },
  'toggle': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-D6VtADmc.js');
    })
  },
  'checkbox': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-B5c9NUGW.js');
    })
  },
  'slider': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-C0pT8OnG.js');
    })
  },
  'placeholder': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-UqPryoEE.js');
    })
  },
  'rate': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-BfN6NMat.js');
    })
  },
  'date': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-KE31_3Wj.js');
    })
  },
  'three-columns': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-CoZusv1X.js');
    })
  },
  'two-columns': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-ClYoFsnJ.js');
    })
  },
  'columns': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DIXtWuxL.js');
    })
  },
  'group': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DAdUU79b.js');
    })
  },
  'placeholder-image': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DS4XlROE.js');
    })
  },
  'divider': {
    'react-material-ui': lazyPreload(function () {
  ...
  'react-view': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-D0ARoRP5.js');
    })
  },
  'datetime': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-BbgsCur7.js');
    })
  },
  'array': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-gQRQzVdX.js');
    })
  },
  'textarea': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-Q6lgfIvy.js');
    })
  },
  'multiselect': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-TVuOI3ii.js');
    })
  },
  'input-number': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-D6q8b7ut.js');
    })
  },
  'radio-group': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-8QOkQwQ2.js');
    })
  },
  'checkbox-group': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-C2Pd75xk.js');
    })
  },
  'tabs': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DjoZIj9q.js');
    })
  },
  'button': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-CloKdGrP.js');
    })
  },
  'upload': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-u0cBBJtH.js');
    })
  },
  'time': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-Bo8EAJa0.js');
    })
  },
  'hidden': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-CoSoAkOC.js');
    })
  }
};
var Forms = {
  'react-material-ui': lazyPreload(function () {
    return import('./index-C5rP83rs.js');
  })
};
...
export { isEmptyForm as $, fillIds as A, styleInject as B, Columns as C, filterOptions as D, isUrl as E, _isFunction as F, Group as G, _isObject as H, I18N as I, isValidTime as J, commonjsGlobal as K, LetsForm as L, Fields as M, Forms as N, Connectors as O, replaceField as P, mapFields as Q, cleanUp as R, findField as S, ThreeColumns as T, reduceFields as U, getFieldById as V, applyFormRules as W, filterFields as X, getLocales as Y, i18n as Z, _objectWithoutProperties as _, _extends as a, isI18n as a0, applyTransformers as a1, formHelper as a2, collectIds as a3, isChildrenOf as a4, isValidConnector as a5, isValidForm as a6, isValidField as a7, isValidArrayOfFields as a8, validateJSONForm as a9, formHasComponents as aa, omitFields as ab, FRAMEWORKS as ac, FRAMEWORKS_LABELS as ad, FIELDS_KEY as ae, LfField as af, LfGroup as ag, LfColumns as ah, LfColumn as ai, LfArray as aj, LfTabs as ak, LfTab as al, LfSteps as am, LfStep as an, traverseChildren as ao, _isNumber as b, _objectSpread2 as c, _isEmpty as d, _isDate as e, _isString as f, isValidDate as g, TwoColumns as h, i18nOptions as i, isValidDayjsFormat as j, _castSlice as k, lfLog as l, makeWidthStyle as m, _hasUnicode as n, _stringToArray as o, passRest as p, getDefaultExportFromCjs as q, _defineProperty$1 as r, classNames as s, toString_1 as t, useFormContext as u, _slicedToArray as v, _toConsumableArray as w, _isArray as x, _omit as y, collectNames as z };
