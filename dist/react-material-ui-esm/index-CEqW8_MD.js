...
var Fields = {
  'input-text': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DJl-n8pO.js');
    })
  },
  'select': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-CXSdfrej.js');
    })
  },
  'toggle': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DeYm2tM0.js');
    })
  },
  'checkbox': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-BZGWFuEP.js');
    })
  },
  'slider': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-ZK1cm9mn.js');
    })
  },
  'placeholder': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-BEuhD_A8.js');
    })
  },
  'rate': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-vjINcGvn.js');
    })
  },
  'date': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-_CBm_K5q.js');
    })
  },
  'three-columns': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DZtpg6nm.js');
    })
  },
  'two-columns': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DRZolZP_.js');
    })
  },
  'columns': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DSmNHsv-.js');
    })
  },
  'group': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DeTSgLEG.js');
    })
  },
  'placeholder-image': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DQV09pV7.js');
    })
  },
  'divider': {
    'react-material-ui': lazyPreload(function () {
  ...
  'react-view': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-BqaXWMK_.js');
    })
  },
  'datetime': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DpvDDdnT.js');
    })
  },
  'array': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-0ijMVAx4.js');
    })
  },
  'textarea': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DJcltU57.js');
    })
  },
  'multiselect': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-C1HlFvpc.js');
    })
  },
  'input-number': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DwwcRGKB.js');
    })
  },
  'radio-group': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-CLDSao2y.js');
    })
  },
  'checkbox-group': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-BlAAzrf2.js');
    })
  },
  'tabs': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-6RW2DzqS.js');
    })
  },
  'button': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-D4QipN1P.js');
    })
  },
  'upload': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-vGDFgtgu.js');
    })
  },
  'time': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-PPQJsRfJ.js');
    })
  },
  'hidden': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-D96n9RrR.js');
    })
  },
  'currency': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-Cz-wS6-j.js');
    })
  }
};
var Forms = {
  'react-material-ui': lazyPreload(function () {
    return import('./index-DhWMuRnl.js');
  })
};
...
export { getLocales as $, collectNames as A, fillIds as B, Columns as C, styleInject as D, filterOptions as E, _isFunction as F, Group as G, _isObject as H, I18N as I, isValidTime as J, commonjsGlobal as K, LetsForm as L, lfWarn as M, isUrl as N, Fields as O, Forms as P, Connectors as Q, replaceField as R, mapFields as S, ThreeColumns as T, cleanUp as U, findField as V, reduceFields as W, getFieldById as X, applyFormRules as Y, filterFields as Z, _objectWithoutProperties as _, _extends as a, i18n as a0, isEmptyForm as a1, isI18n as a2, applyTransformers as a3, formHelper as a4, collectIds as a5, isChildrenOf as a6, isValidConnector as a7, isValidForm as a8, isValidField as a9, isValidArrayOfFields as aa, validateJSONForm as ab, formHasComponents as ac, omitFields as ad, someFields as ae, FRAMEWORKS as af, FRAMEWORKS_LABELS as ag, FIELDS_KEY as ah, LfField as ai, LfGroup as aj, LfColumns as ak, LfColumn as al, LfArray as am, LfTabs as an, LfTab as ao, LfSteps as ap, LfStep as aq, traverseChildren as ar, _isNumber as b, _objectSpread2 as c, _isEmpty as d, _isDate as e, _isString as f, isValidDate as g, TwoColumns as h, i18nOptions as i, makeWidthStyle as j, isValidDayjsFormat as k, lfLog as l, makeClassName as m, _castSlice as n, _hasUnicode as o, passRest as p, _stringToArray as q, getDefaultExportFromCjs as r, _defineProperty$1 as s, toString_1 as t, classNames as u, useFormContext as v, _slicedToArray as w, _toConsumableArray as x, _isArray as y, _omit as z };
