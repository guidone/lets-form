...
var Fields = {
  'input-text': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-BTpxrGic.js');
    })
  },
  'select': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-t3dH373L.js');
    })
  },
  'toggle': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-HVOGcYpS.js');
    })
  },
  'checkbox': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-C4OR8pJK.js');
    })
  },
  'slider': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-BcfMaMT8.js');
    })
  },
  'placeholder': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-B1-nVt_I.js');
    })
  },
  'rate': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-D2Z2PL1y.js');
    })
  },
  'date': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-BeoYXrud.js');
    })
  },
  'three-columns': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-CGbgL7ik.js');
    })
  },
  'two-columns': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-CrU6MV5P.js');
    })
  },
  'columns': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-Cd0sl6RV.js');
    })
  },
  'group': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-XoXruPyL.js');
    })
  },
  'object': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-D1b51EPW.js');
    })
  },
  'placeholder-image': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DyASweAs.js');
    })
  },
  'divider': {
    'react-material-ui': lazyPreload(function () {
  ...
  'react-view': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-B8svX1X9.js');
    })
  },
  'datetime': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-B1ZouL1-.js');
    })
  },
  'array': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-Y_xUvLOO.js');
    })
  },
  'textarea': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-CZdJH1Eb.js');
    })
  },
  'multiselect': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DI27Ch4m.js');
    })
  },
  'input-number': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-BgbrHchQ.js');
    })
  },
  'radio-group': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-Dwc86R4d.js');
    })
  },
  'checkbox-group': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-eiXJDqua.js');
    })
  },
  'tabs': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-78waFabS.js');
    })
  },
  'button': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-pb2kPtFg.js');
    })
  },
  'upload': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-CBIdnIUq.js');
    })
  },
  'time': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-D5Upe9FY.js');
    })
  },
  'hidden': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DfEvwIi7.js');
    })
  },
  'currency': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-Bczj2Uyt.js');
    })
  }
};
var Forms = {
  'react-material-ui': lazyPreload(function () {
    return import('./index-CClg4YHS.js');
  })
};
...
export { applyFormRules as $, _toConsumableArray as A, _isArray as B, Columns as C, _omit as D, collectNames as E, fillIds as F, Group as G, _isObject as H, I18N as I, filterOptions as J, _isFunction as K, LetsForm as L, isValidTime as M, commonjsGlobal as N, lfWarn as O, isUrl as P, Fields as Q, Forms as R, Connectors as S, ThreeColumns as T, replaceField as U, mapFields as V, cleanUp as W, findField as X, reduceFields as Y, getFieldById as Z, _objectWithoutProperties as _, _extends as a, filterFields as a0, getLocales as a1, i18n as a2, isEmptyForm as a3, isI18n as a4, applyTransformers as a5, formHelper as a6, collectIds as a7, isChildrenOf as a8, isValidConnector as a9, isValidForm as aa, isValidField as ab, isValidArrayOfFields as ac, validateJSONForm as ad, formHasComponents as ae, omitFields as af, someFields as ag, FRAMEWORKS as ah, FRAMEWORKS_LABELS as ai, FIELDS_KEY as aj, LfField as ak, LfGroup as al, LfObject as am, LfColumns as an, LfColumn as ao, LfArray as ap, LfTabs as aq, LfTab as ar, LfSteps as as, LfStep as at, traverseChildren as au, _isNumber as b, _objectSpread2 as c, _isEmpty as d, _isDate as e, _isString as f, isValidDate as g, TwoColumns as h, i18nOptions as i, _slicedToArray as j, classNames as k, lfLog as l, makeClassName as m, ChevronUp as n, ChevronDown as o, passRest as p, makeWidthStyle as q, isValidDayjsFormat as r, styleInject as s, _castSlice as t, useFormContext as u, _hasUnicode as v, _stringToArray as w, toString_1 as x, getDefaultExportFromCjs as y, _defineProperty$1 as z };
