...
var Fields = {
  'input-text': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-JcNA2Xn6.js');
    })
  },
  'select': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-Coq8xMRu.js');
    })
  },
  'toggle': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-FBnHburl.js');
    })
  },
  'checkbox': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-B8D3Jpnz.js');
    })
  },
  'slider': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-Bv5pmIbp.js');
    })
  },
  'placeholder': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-YPtuNRgm.js');
    })
  },
  'rate': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-B99HV8tt.js');
    })
  },
  'date': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-Djvjp4sR.js');
    })
  },
  'three-columns': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-C12eep39.js');
    })
  },
  'two-columns': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-1N51LTGh.js');
    })
  },
  'group': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-BvutfxgB.js');
    })
  },
  'placeholder-image': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-CJMZvnub.js');
    })
  },
  'divider': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-wBGuePZ0.js');
    })
  },
  'react-view': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-CoiE1xHp.js');
    })
  },
  'datetime': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-A_oLgLb_.js');
    })
  },
  'array': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-pGKBG0Ef.js');
    })
  },
  'textarea': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-BSZD9FLA.js');
    })
  },
  'multiselect': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-vHXqi_zD.js');
    })
  },
  'input-number': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-BKE8_UTF.js');
    })
  },
  'radio-group': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-D7XRGPNe.js');
    })
  },
  'checkbox-group': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DKWbn4co.js');
    })
  },
  'tabs': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-qk2sDQVh.js');
    })
  },
  'button': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-wBtaf8h8.js');
    })
  },
  'upload': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-_T8a0Wqi.js');
    })
  },
  'time': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-CJb11y39.js');
    })
  },
  'hidden': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-C_M0QQmg.js');
    })
  }
};
var Forms = {
  'react-material-ui': lazyPreload(function () {
    return import('./index-D-WqyqaD.js');
  })
};
...
export { filterFields as $, fillIds as A, styleInject as B, _objectDestructuringEmpty as C, filterOptions as D, isUrl as E, _isFunction as F, Group as G, _isObject as H, I18N as I, isValidTime as J, commonjsGlobal as K, LetsForm as L, Fields as M, Forms as N, replaceField as O, mapFields as P, deleteField as Q, cleanUp as R, addField as S, ThreeColumns as T, findField as U, createEmptyField as V, reduceFields as W, getFieldById as X, applyFormRules as Y, validateRulesDefinition as Z, _objectWithoutProperties as _, _extends as a, getLocales as a0, i18n as a1, isEmptyForm as a2, isI18n as a3, applyTransformers as a4, formHelper as a5, collectIds as a6, isChildrenOf as a7, validateJSONForm as a8, formHasComponents as a9, omitFields as aa, FRAMEWORKS as ab, FRAMEWORKS_LABELS as ac, FIELDS_KEY as ad, _isNumber as b, _objectSpread2 as c, _isEmpty as d, _isDate as e, _isString as f, isValidDate as g, TwoColumns as h, i18nOptions as i, isValidDayjsFormat as j, _castSlice as k, lfLog as l, makeWidthStyle as m, _hasUnicode as n, _stringToArray as o, passRest as p, getDefaultExportFromCjs as q, _defineProperty$1 as r, classNames as s, toString_1 as t, useFormContext as u, _slicedToArray as v, _toConsumableArray as w, _isArray as x, _omit as y, collectNames as z };
