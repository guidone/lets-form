/* LetsForm react-material-ui v0.7.19 - ESM */
...
var Fields = {
  'input-text': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DyzDmU13.js');
    })
  },
  'select': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DbLZzVpw.js');
    })
  },
  'toggle': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-GQRUdGE6.js');
    })
  },
  'checkbox': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DYz1sCmr.js');
    })
  },
  'slider': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-BqbJvHxf.js');
    })
  },
  'placeholder': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-B21fcwf2.js');
    })
  },
  'rate': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-L3nLZ6Lp.js');
    })
  },
  'date': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-bVynCC4Q.js');
    })
  },
  'three-columns': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-B_Mn2W1T.js');
    })
  },
  'two-columns': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DS5Niw9q.js');
    })
  },
  'group': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-BvUB7e8Q.js');
    })
  },
  'placeholder-image': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-BKcvEWVJ.js');
    })
  },
  'divider': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-CfdQcS9V.js');
    })
  },
  'react-view': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DcdXJVaY.js');
    })
  },
  'datetime': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-e8xz1PfO.js');
    })
  },
  'array': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-RB2wWUoM.js');
    })
  },
  'textarea': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-CRUM5dP9.js');
    })
  },
  'multiselect': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-BTlj4A5D.js');
    })
  },
  'input-number': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-CqQNJeAs.js');
    })
  },
  'radio-group': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-lJ17kCLj.js');
    })
  },
  'checkbox-group': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-BlTwTUdm.js');
    })
  },
  'tabs': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DBZnB52n.js');
    })
  },
  'button': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-dX3dtOly.js');
    })
  },
  'upload': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DOI5XEpW.js');
    })
  },
  'time': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-FyxHZ7fW.js');
    })
  },
  'hidden': {
    'react-material-ui': lazyPreload(function () {
      return import('./index-DXlJsetS.js');
    })
  }
};
var Forms = {
  'react-material-ui': lazyPreload(function () {
    return import('./index-Bo4lz24g.js');
  })
};
...
export { getLocales as $, fillIds as A, styleInject as B, filterOptions as C, isUrl as D, _isFunction as E, _isObject as F, Group as G, isValidTime as H, I18N as I, commonjsGlobal as J, Fields as K, LetsForm as L, Forms as M, replaceField as N, mapFields as O, deleteField as P, cleanUp as Q, addField as R, findField as S, ThreeColumns as T, createEmptyField as U, reduceFields as V, getFieldById as W, applyFormRules as X, validateRulesDefinition as Y, filterFields as Z, _objectWithoutProperties as _, _extends as a, i18n as a0, isEmptyForm as a1, isI18n as a2, applyTransformers as a3, formHelper as a4, collectIds as a5, isChildrenOf as a6, validateJSONForm as a7, formHasComponents as a8, omitFields as a9, FRAMEWORKS as aa, FRAMEWORKS_LABELS as ab, FIELDS_KEY as ac, _isNumber as b, _objectSpread2 as c, _isEmpty as d, _isDate as e, _isString as f, isValidDate as g, TwoColumns as h, i18nOptions as i, isValidDayjsFormat as j, _castSlice as k, lfLog as l, makeWidthStyle as m, _hasUnicode as n, _stringToArray as o, passRest as p, getDefaultExportFromCjs as q, _defineProperty$1 as r, classNames as s, toString_1 as t, useFormContext as u, _slicedToArray as v, _toConsumableArray as w, _isArray as x, _omit as y, collectNames as z };
