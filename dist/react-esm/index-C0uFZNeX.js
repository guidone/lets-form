...
var Fields = {
  'input-text': {
    'react': lazyPreload(function () {
      return import('./index-Cw2W4OXT.js');
    })
  },
  'input-number': {
    'react': lazyPreload(function () {
      return import('./index-D9_cyaqN.js');
    })
  },
  'checkbox': {
    'react': lazyPreload(function () {
      return import('./index-N1cqlrIq.js');
    })
  },
  'textarea': {
    'react': lazyPreload(function () {
      return import('./index-rPTw4GHz.js');
    })
  },
  'three-columns': {
    'react': lazyPreload(function () {
      return import('./index-BrAe6UG5.js');
    })
  },
  'two-columns': {
    'react': lazyPreload(function () {
      return import('./index-Dzdlc3y_.js');
    })
  },
  'group': {
    'react': lazyPreload(function () {
      return import('./index-Bb7T2d3_.js');
    })
  },
  'divider': {
    'react': lazyPreload(function () {
      return import('./index-C4nLfX2X.js');
    })
  },
  'react-view': {
    'react': lazyPreload(function () {
      return import('./index-BYs3V4Fm.js');
    })
  },
  'placeholder': {
    'react': lazyPreload(function () {
      return import('./index-CGyWmJWt.js');
    })
  },
  'select': {
    'react': lazyPreload(function () {
      return import('./index-BV9Ipk6m.js');
    })
  },
  'date': {
    'react': lazyPreload(function () {
      return import('./index-1h-NAhm0.js');
    })
  },
  'datetime': {
    'react': lazyPreload(function () {
      return import('./index-Cgc2xjPu.js');
    })
  },
  'array': {
    'react': lazyPreload(function () {
      return import('./index-A-5_YEo7.js');
    })
  },
  'placeholder-image': {
    'react': lazyPreload(function () {
      return import('./index-C-4roMhK.js');
    })
  },
  'button': {
    'react': lazyPreload(function () {
      return import('./index-DAIigX-o.js');
    })
  },
  'upload': {
    'react': lazyPreload(function () {
      return import('./index-CoPJgyqb.js');
    })
  }
...
var Forms = {
  'react': lazyPreload(function () {
    return import('./index-BOQni154.js');
  })
};
...
export { isUrl as $, _isFunction as A, _isObject as B, Forms as C, replaceField as D, mapFields as E, Fields as F, Group as G, deleteField as H, I18N as I, cleanUp as J, addField as K, LetsForm as L, findField as M, createEmptyField as N, reduceFields as O, getFieldById as P, applyFormRules as Q, validateRulesDefinition as R, isValidDayjsFormat as S, ThreeColumns as T, filterFields as U, getLocales as V, i18n as W, isEmptyForm as X, isI18n as Y, applyTransformers as Z, _objectWithoutProperties as _, _extends as a, formHelper as a0, collectIds as a1, isChildrenOf as a2, validateJSONForm as a3, formHasComponents as a4, FRAMEWORKS as a5, FRAMEWORKS_LABELS as a6, FIELDS_KEY as a7, _isString as b, classNames as c, TwoColumns as d, _isEmpty as e, filterOptions as f, _toConsumableArray as g, isValidDate as h, i18nOptions as i, _castSlice as j, _hasUnicode as k, lfLog as l, makeWidthStyle as m, _stringToArray as n, getDefaultExportFromCjs as o, passRest as p, _isNumber as q, _defineProperty$1 as r, styleInject as s, toString_1 as t, useFormContext as u, _slicedToArray as v, _isArray as w, _omit as x, collectNames as y, fillIds as z };
