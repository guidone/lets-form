...
import { s as styleInject, I as I18N, l as lfLog, k as _isArray, n as _isObject, d as _slicedToArray, E as _toConsumableArray } from './index-DRF8thTp.js';
import React__default, { useCallback, useState } from 'react';
import Button from '@mui/material/Button';
import FormHelperText from '@mui/material/FormHelperText';
import { C as CrossCirle } from './cross-circle-B7un7GbV.js';
...
var FileItem = function FileItem(_ref) {
  ...
  }, /*#__PURE__*/React__default.createElement(IconAttachment, {
    width: 16,
    height: 16,
    color: "#666666"
  })), /*#__PURE__*/React__default.createElement("div", {
    className: "lf-name"
  }, file.name), /*#__PURE__*/React__default.createElement("div", {
    className: "lf-size"
  }, formatBytes(file.size)), /*#__PURE__*/React__default.createElement("a", {
    className: "lf-clear-button",
    href: "#",
    onClick: handleClick
  }, /*#__PURE__*/React__default.createElement(CrossCirle, {
    color: "#666666",
    width: 16,
    height: 16
  })));
...
var Upload = I18N(function (_ref) {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    startIcon: uploadButtonIcon ? /*#__PURE__*/React__default.createElement("img", {
      className: "lf-icon",
      src: uploadButtonIcon
    }) : undefined
  }, uploadButtonLabel || 'Upload', /*#__PURE__*/React__default.createElement("input", {
    type: "file",
    accept: accept,
  ...
  }, !multiple && currentFile && /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement("span", {
    className: "lf-upload-file-name"
  }, currentFile.name, "\xA0", /*#__PURE__*/React__default.createElement("span", {
    className: "lf-size"
  }, formatBytes(currentFile.size))), "\xA0", /*#__PURE__*/React__default.createElement("a", {
    href: "#",
    onClick: handleClear
  }, /*#__PURE__*/React__default.createElement(CrossCirle, {
    color: "#666666",
    width: 16,
    height: 16
  }))))), hint && !error && /*#__PURE__*/React__default.createElement(FormHelperText, null, hint), multiple && currentFile && /*#__PURE__*/React__default.createElement("div", {
