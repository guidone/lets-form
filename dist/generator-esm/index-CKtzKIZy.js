...
import { I as I18N, l as lfLog, a as _objectWithoutProperties, d as _slicedToArray, o as _objectSpread2 } from './index-BlDYFeHM.js';
...
var RadioTileRSuite = I18N(function (_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(Form.Group, {
    ...
    tooltip: true
  }, hint), required && /*#__PURE__*/React__default.createElement(RequiredIcon, null)), /*#__PURE__*/React__default.createElement(RadioTileGroup, {
    value: currentValue,
    onChange: handleChange,
    inline: inline,
    disabled: disabled
  }, (options || []).map(function (option) {
    return /*#__PURE__*/React__default.createElement(RadioTile, {
      key: option.value,
      label: option.label,
      value: option.value,
      icon: option.icon && /*#__PURE__*/React__default.createElement("img", {
        src: option.icon,
        width: iconWidth,
        height: iconHeight
      })
