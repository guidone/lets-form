...
import { s as styleInject$1, A as _typeof$1, l as lfLog$1, I as I18N$1, _ as _objectWithoutProperties$1, g as _slicedToArray$1, a as _isString$1, c as classNames$1, d as _defineProperty$1$1, m as makeWidthStyle$1, b as _extends$1 } from './index-Cn9nwTB0.js';
import React$1, { createContext, useContext, useState, useCallback, useEffect, forwardRef, useRef, useImperativeHandle, createElement, Suspense, lazy } from 'react';
import { Form, InputNumber } from 'rsuite';
import { R as RequiredIcon } from './index-BSRGt_hk-CHB_aTs8.js';
import { R as RSuite5FieldControl } from './index-CJYOLjUg-BuYaf1ph.js';
...
var Fields = {
  'input-text': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-Dif4iZsN-1PNY086B-DOYGFP8z.js');
    })
  },
  'toggle': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-SqL7uj4Y-CxSjG3Ga-C054AtbZ.js');
    })
  },
  'select': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-BJ4-Agw0-20zOI27t-CikK2ZlY.js');
    })
  },
  'group': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-2DdSprz3-EHEhLQKS-BkuWY8h9.js');
    })
  },
  'array': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-CctKFRRz-BtxwdW-o-DnsylEm0.js');
    })
  },
  'two-columns': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-CvppglFf-Cv-jwfpu-B3fFzQAZ.js');
    })
  },
  'three-columns': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-w2dSYcHb-CXDpGzIs-BGKVxD8J.js');
    })
  },
  'input-number': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-DpKM_8GA-eSPfMLwa-JpnNUllM.js').then(function (n) {
        return n.N;
      });
    })
  },
  'date': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-B5nDPdNs-pCCUyBXU-BwT0LXr9.js');
    })
  },
  'checkbox': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-B3P_D5MC-B_xZdx6e-ChNMTof-.js');
    })
  },
  'checkbox-group': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-DXuMGa1i-DYlEmK51-BYXTsBo8.js');
    })
  },
  'slider': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-Dl5hpN7I-DJB0Q98q-BXzN3nED.js');
    })
  },
  'radio-group': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-3peXjNat-B_D3S57j-NNm-Nz1s.js');
    })
  },
  'input-tag': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-FjLPMBpm-srUWpww8-blu3BslY.js');
    })
  },
  'input-mask': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-C5zoZBnQ-_M12qutb-CNFzgk6x.js');
    })
  },
  'textarea': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-Du43imtq-B9-yaDA9-CF25wt0H.js');
    })
  },
  'rate': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-fdTn8OKS-qNzF7pFD-UeEG-FCB.js');
    })
  },
  'placeholder': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-Dmu7ZL-U-D4XP9klL-Du2bUx_p.js');
    })
  },
  'multiselect': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-DXrKOVmi-BrMMxPb_-BTc7SXcl.js');
    })
  },
  'multiselect-language': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-GOGguJGp-COCm27y2-uY8q4WBr.js');
    })
  },
  'input-text-i18n': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-BpbQ6Zb9-UMdo7R5G-Dl5BVZIA.js');
    })
  },
  'placeholder-image': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-Dv4np-9Z-DGiBI-N--thrgD9fu.js');
    })
  },
  'button': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-2Rqmlndh-C1m2W9T0-C_hUCTIl.js');
    })
  },
  'divider': {
    'react-rsuite5': lazyPreload(function () {
  ...
  'react-view': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-bLbiLBsr-CsgRJ6Yj-C1qkU90R.js');
    })
  },
  'datetime': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-nvrYUW12-Btx8z37I-BX-BrWrv.js');
    })
  },
  'tabs': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-2NmYinRv-DGfm3ehX-C4w8_mPH.js');
    })
  },
  'radio-tile': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-IBND4pwJ-D7ys8_7W-CqNEfkvg.js');
    })
  },
  'upload': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-le4JhiNn-DBt92q18-BhQ2HYhw.js');
    })
  },
  'buttons-toggle-group': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-C5zbVWFV-CEb0DAfu-MKkwqsTT.js');
    })
  },
  'steps': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index--wGNU2cw-DPNYWbus-B2tRG29d.js');
    })
  },
  'esm-module': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-D_sJ1Ysc-DzPX55zN-DGQSjdJf.js');
    })
  },
  'time': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-D44NpZmu-DKGbNKJV-BYpRqlTt.js');
    })
  },
  'hidden': {
    'react-rsuite5': lazyPreload(function () {
      return import('./index-z8Sdas0X-USDPLX5A-D9nz6E2A.js');
    })
  }
};
var Forms = {
  'react-rsuite5': lazyPreload(function () {
    return import('./index-CjYIiJhu-Ch6l6CyE-CGiZfBjC.js');
  })
};
