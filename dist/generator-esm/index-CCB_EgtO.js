...
import { s as styleInject, I as I18N, l as lfLog, a as _objectWithoutProperties, r as _isEmpty, b as _extends } from './index-DRF8thTp.js';
...
var MantineButton = function MantineButton(_ref) {
  ...
  if (!_isEmpty(label) && !_isEmpty(icon)) {
    inner = /*#__PURE__*/React__default.createElement(Button, _extends({
      leftSection: /*#__PURE__*/React__default.createElement("img", {
        className: "lf-icon",
        src: icon
      })
    }, rest), label);
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, !_isEmpty(hint) && tooltip && /*#__PURE__*/React__default.createElement(Tooltip, {
    label: hint,
    withArrow: true
  }, inner), (_isEmpty(hint) || !tooltip) && inner, !_isEmpty(hint) && !tooltip && /*#__PURE__*/React__default.createElement(Input.Description, null, hint));
};
