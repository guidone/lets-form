...
import { s as styleInject, I as I18N, l as lfLog, a as _objectWithoutProperties, r as _isEmpty, d as _slicedToArray, k as _isArray, b as _extends, p as passRest, v as _isFunction, e as classNames, o as _objectSpread2 } from './index-BlDYFeHM.js';
import React__default, { useState, useCallback } from 'react';
import { Steps, Button } from 'antd';
import { G as GenericIcon } from './generic-icon-BPCK2EbG.js';
...
var AntdSteps = I18N(function (_ref) {
  ...
  var antdSteps = (steps || []).map(function (step) {
    return {
      ...
      icon: step.icon ? /*#__PURE__*/React__default.createElement(GenericIcon, {
        icon: step.icon
      }) : undefined
    };
  });
  ...
  }, /*#__PURE__*/React__default.createElement(Steps, _extends({
    current: stepIdx,
    status: status,
    percent: percent,
    type: stepsType,
  ...
  }, passRest(rest))), _isFunction(children) && /*#__PURE__*/React__default.createElement("div", {
    className: "lf-step"
  }, children(step)), /*#__PURE__*/React__default.createElement("div", {
  ...
  }, labelPrevious || 'Previous'), /*#__PURE__*/React__default.createElement(Button, {
    onClick: handleNext,
