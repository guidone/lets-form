...
import { s as styleInject, I as I18N, l as lfLog, a as _objectWithoutProperties, d as _slicedToArray, r as _isEmpty, b as _extends, k as _isArray, p as passRest } from './index-DRF8thTp.js';
...
var ShieldedButton = function ShieldedButton(_ref) {
  ...
  var inner = /*#__PURE__*/React__default.createElement(Button, _extends({}, rest, {
    size: superSize,
...
var Upload = I18N(function (_ref2) {
  ...
  if (draggable) {
    ...
    }, /*#__PURE__*/React__default.createElement("span", null, draggableText || 'Click or Drag files to this area to upload'));
  } else {
    inner = /*#__PURE__*/React__default.createElement(ShieldedButton, {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    tooltip: true
  }, hint), required && /*#__PURE__*/React__default.createElement(RequiredIcon, null)), /*#__PURE__*/React__default.createElement(Uploader, _extends({
    autoUpload: false,
    action: "",
  ...
  }, passRest(rest)), inner), hint && draggable && !tooltip && /*#__PURE__*/React__default.createElement(Form.HelpText, null, hint));
