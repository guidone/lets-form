/* LetsForm react-antd v0.10.3 - ESM */
...
var Fields = {
  'input-text': {
    'react-antd': lazyPreload(function () {
      return import('./index-BPHqaIXq.js');
    })
  },
  'toggle': {
    'react-antd': lazyPreload(function () {
      return import('./index-DX0kq7Um.js');
    })
  },
  'checkbox': {
    'react-antd': lazyPreload(function () {
      return import('./index-B46WXWtv.js');
    })
  },
  'date': {
    'react-antd': lazyPreload(function () {
      return import('./index-D84KL3qT.js');
    })
  },
  'select': {
    'react-antd': lazyPreload(function () {
      return import('./index-DWT6RCYj.js');
    })
  },
  'radio-group': {
    'react-antd': lazyPreload(function () {
      return import('./index-C2guc1U4.js');
    })
  },
  'rate': {
    'react-antd': lazyPreload(function () {
      return import('./index-Dn7kISep.js');
    })
  },
  'placeholder': {
    'react-antd': lazyPreload(function () {
      return import('./index-CH5DvuYd.js');
    })
  },
  'placeholder-image': {
    'react-antd': lazyPreload(function () {
      return import('./index-BiXLqNPU.js');
    })
  },
  'input-number': {
    'react-antd': lazyPreload(function () {
      return import('./index-C5JK2eCh.js');
    })
  },
  'textarea': {
    'react-antd': lazyPreload(function () {
      return import('./index-BqoprKvt.js');
    })
  },
  'multiselect': {
    'react-antd': lazyPreload(function () {
      return import('./index-CBlMzXbg.js');
    })
  },
  'three-columns': {
    'react-antd': lazyPreload(function () {
      return import('./index-CXcsbCIZ.js');
    })
  },
  'columns': {
    'react-antd': lazyPreload(function () {
      return import('./index-nUIw-zXA.js');
    })
  },
  'two-columns': {
    'react-antd': lazyPreload(function () {
      return import('./index-e7VBhz5C.js');
    })
  },
  'group': {
    'react-antd': lazyPreload(function () {
      return import('./index-CZwGoo7U.js');
    })
  },
  'slider': {
    'react-antd': lazyPreload(function () {
      return import('./index-p47DYDxL.js');
    })
  },
  'divider': {
    'react-antd': lazyPreload(function () {
  ...
  'react-view': {
    'react-antd': lazyPreload(function () {
      return import('./index-Bj-svjqO.js');
    })
  },
  'datetime': {
    'react-antd': lazyPreload(function () {
      return import('./index-DXsy63KQ.js');
    })
  },
  'array': {
    'react-antd': lazyPreload(function () {
      return import('./index-BJOJKNNw.js');
    })
  },
  'button': {
    'react-antd': lazyPreload(function () {
      return import('./index-DYPKdALo.js');
    })
  },
  'checkbox-group': {
    'react-antd': lazyPreload(function () {
      return import('./index-W8g12KyH.js');
    })
  },
  'tabs': {
    'react-antd': lazyPreload(function () {
      return import('./index-6uquQOX4.js');
    })
  },
  'upload': {
    'react-antd': lazyPreload(function () {
      return import('./index-8ZGr5t0X.js');
    })
  },
  'buttons-toggle-group': {
    'react-antd': lazyPreload(function () {
      return import('./index-D7Hdd4aG.js');
    })
  },
  'steps': {
    'react-antd': lazyPreload(function () {
      return import('./index-DoJkoJI_.js');
    })
  },
  'hidden': {
    'react-antd': lazyPreload(function () {
      return import('./index-uJD7GUKw.js');
    })
  },
  'time': {
    'react-antd': lazyPreload(function () {
      return import('./index-BbpZnti1.js');
    })
  }
};
var Forms = {
  'react-antd': lazyPreload(function () {
    return import('./index-ByyovI7l.js');
  })
};
...
export { getLocales as $, _toConsumableArray as A, collectNames as B, Columns as C, fillIds as D, _isFunction as E, isValidTime as F, Group as G, commonjsGlobal as H, I18N as I, Fields as J, Forms as K, LetsForm as L, Connectors as M, replaceField as N, mapFields as O, deleteField as P, cleanUp as Q, addField as R, findField as S, ThreeColumns as T, createEmptyField as U, reduceFields as V, getFieldById as W, applyFormRules as X, isValidDayjsFormat as Y, filterFields as Z, _objectWithoutProperties as _, _extends as a, i18n as a0, isEmptyForm as a1, isI18n as a2, applyTransformers as a3, formHelper as a4, collectIds as a5, isChildrenOf as a6, isValidConnector as a7, isValidForm as a8, isValidField as a9, isValidArrayOfFields as aa, validateJSONForm as ab, formHasComponents as ac, omitFields as ad, FRAMEWORKS as ae, FRAMEWORKS_LABELS as af, FIELDS_KEY as ag, LfField as ah, LfGroup as ai, LfColumns as aj, LfColumn as ak, LfArray as al, LfTabs as am, LfTab as an, LfSteps as ao, LfStep as ap, traverseChildren as aq, _isDate as b, classNames as c, _isString as d, i18nOptions as e, _omit as f, _isEmpty as g, isUrl as h, isValidDate as i, filterOptions as j, TwoColumns as k, lfLog as l, makeWidthStyle as m, _isArray as n, _objectSpread2 as o, passRest as p, _defineProperty$1 as q, _castSlice as r, styleInject as s, _hasUnicode as t, _stringToArray as u, toString_1 as v, getDefaultExportFromCjs as w, _isNumber as x, useFormContext as y, _slicedToArray as z };
