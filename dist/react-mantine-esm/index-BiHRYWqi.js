/* LetsForm react-mantine v0.8.2 - ESM */
...
var Fields = {
  'input-text': {
    'react-mantine': lazyPreload(function () {
      return import('./index-hAhIdxXM.js');
    })
  },
  'input-number': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DFHW9WLG.js');
    })
  },
  'textarea': {
    'react-mantine': lazyPreload(function () {
      return import('./index-v2Q1Ez_A.js');
    })
  },
  'select': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BvItUh8M.js');
    })
  },
  'checkbox': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DJdIKRGI.js');
    })
  },
  'toggle': {
    'react-mantine': lazyPreload(function () {
      return import('./index-Brc7qoAC.js');
    })
  },
  'array': {
    'react-mantine': lazyPreload(function () {
      return import('./index-PgNBtBqo.js');
    })
  },
  'checkbox-group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CBOt7oJ2.js');
    })
  },
  'radio-group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-C3r-xjbM.js');
    })
  },
  'two-columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DAuby9Wm.js');
    })
  },
  'three-columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-D4NPP-LC.js');
    })
  },
  'group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DGFkxtj5.js');
    })
  },
  'date': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DN4eWWmV.js');
    })
  },
  'datetime': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BoKvZS11.js');
    })
  },
  'rate': {
    'react-mantine': lazyPreload(function () {
      return import('./index-B2-0olzS.js');
    })
  },
  'placeholder': {
    'react-mantine': lazyPreload(function () {
      return import('./index-ClSaaL4_.js');
    })
  },
  'placeholder-image': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CGjRdHDi.js');
    })
  },
  'divider': {
    'react-mantine': lazyPreload(function () {
  ...
  'slider': {
    'react-mantine': lazyPreload(function () {
      return import('./index-G77dkXxY.js');
    })
  },
  'input-tag': {
    'react-mantine': lazyPreload(function () {
      return import('./index-Da3skPYB.js');
    })
  },
  'tabs': {
    'react-mantine': lazyPreload(function () {
      return import('./index-UahZ9Ch0.js');
    })
  },
  'button': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BaXBYxkq.js');
    })
  },
  'upload': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CcInmPuK.js');
    })
  },
  'multiselect': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DO4Ta5M-.js');
    })
  },
  'steps': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DK7NyChc.js');
    })
  },
  'time': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CRNcpKth.js');
    })
  },
  'hidden': {
    'react-mantine': lazyPreload(function () {
      return import('./index-Cu1mZ9VW.js');
    })
  }
};
var Forms = {
  'react-mantine': lazyPreload(function () {
    return import('./index-JI-DdQHw.js');
  })
};
...
export { isI18n as $, _objectSpread2 as A, isUrl as B, styleInject as C, _isFunction as D, Forms as E, Fields as F, Group as G, replaceField as H, I18N as I, mapFields as J, deleteField as K, LetsForm as L, cleanUp as M, addField as N, findField as O, createEmptyField as P, reduceFields as Q, getFieldById as R, applyFormRules as S, TwoColumns as T, validateRulesDefinition as U, isValidDayjsFormat as V, filterFields as W, getLocales as X, i18n as Y, isEmptyForm as Z, _objectWithoutProperties as _, _extends as a, applyTransformers as a0, formHelper as a1, collectIds as a2, isChildrenOf as a3, validateJSONForm as a4, formHasComponents as a5, isValidTime as a6, omitFields as a7, FRAMEWORKS as a8, FRAMEWORKS_LABELS as a9, FIELDS_KEY as aa, _isString as b, _castSlice as c, _hasUnicode as d, _stringToArray as e, filterOptions as f, getDefaultExportFromCjs as g, _isNumber as h, i18nOptions as i, _defineProperty$1 as j, classNames as k, lfLog as l, makeWidthStyle as m, _slicedToArray as n, _toConsumableArray as o, passRest as p, _isArray as q, _omit as r, collectNames as s, toString_1 as t, useFormContext as u, _isEmpty as v, fillIds as w, ThreeColumns as x, _isDate as y, isValidDate as z };
