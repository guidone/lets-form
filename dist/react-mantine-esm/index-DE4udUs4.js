...
var Fields = {
  'input-text': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BrxJTWPb.js');
    })
  },
  'input-number': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CHuZhOqj.js');
    })
  },
  'textarea': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BBSfKAuH.js');
    })
  },
  'select': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DeM6Vnzi.js');
    })
  },
  'checkbox': {
    'react-mantine': lazyPreload(function () {
      return import('./index-B3L3Yyl_.js');
    })
  },
  'toggle': {
    'react-mantine': lazyPreload(function () {
      return import('./index-Ks4g1nQF.js');
    })
  },
  'array': {
    'react-mantine': lazyPreload(function () {
      return import('./index-79zGJSms.js');
    })
  },
  'checkbox-group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-Gi6YKq79.js');
    })
  },
  'radio-group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-YtXDKGj0.js');
    })
  },
  'two-columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CyQtzt_G.js');
    })
  },
  'three-columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BSq0d51G.js');
    })
  },
  'columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BuT4hRGs.js');
    })
  },
  'group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-Bsd-CVAc.js');
    })
  },
  'object': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CCyh9hKG.js').then(function (n) { return n.i; });
    })
  },
  'date': {
    'react-mantine': lazyPreload(function () {
      return import('./index-PlUkm86e.js');
    })
  },
  'datetime': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DYkPnP47.js');
    })
  },
  'rate': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CfcVm9f1.js');
    })
  },
  'placeholder': {
    'react-mantine': lazyPreload(function () {
      return import('./index-D46Y17ty.js');
    })
  },
  'placeholder-image': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BeSZIpZ0.js');
    })
  },
  'divider': {
    'react-mantine': lazyPreload(function () {
  ...
  'slider': {
    'react-mantine': lazyPreload(function () {
      return import('./index-T5_Das6_.js');
    })
  },
  'input-tag': {
    'react-mantine': lazyPreload(function () {
      return import('./index-GdbDS8Wy.js');
    })
  },
  'tabs': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BdyRrSzH.js');
    })
  },
  'button': {
    'react-mantine': lazyPreload(function () {
      return import('./index-GM-OncZv.js');
    })
  },
  'upload': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DGsVknVO.js');
    })
  },
  'multiselect': {
    'react-mantine': lazyPreload(function () {
      return import('./index-1OPPdy8D.js');
    })
  },
  'steps': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BlxITqXU.js');
    })
  },
  'time': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CIzde2Hd.js');
    })
  },
  'hidden': {
    'react-mantine': lazyPreload(function () {
  ...
  'currency': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CCO_N9W3.js');
    })
  }
};
var Forms = {
  'react-mantine': lazyPreload(function () {
    return import('./index-DNpjl2HE.js');
  })
};
...
export { isValidDayjsFormat as $, _castSlice as A, _hasUnicode as B, Columns as C, _stringToArray as D, toString_1 as E, getDefaultExportFromCjs as F, Group as G, _isNumber as H, I18N as I, collectNames as J, fillIds as K, LetsForm as L, _isObject as M, isUrl as N, lfWarn as O, Fields as P, Forms as Q, Connectors as R, replaceField as S, TwoColumns as T, mapFields as U, cleanUp as V, findField as W, reduceFields as X, getFieldById as Y, applyFormRules as Z, _objectWithoutProperties as _, _extends as a, filterFields as a0, getLocales as a1, i18n as a2, isEmptyForm as a3, isI18n as a4, applyTransformers as a5, formHelper as a6, collectIds as a7, isChildrenOf as a8, isValidConnector as a9, isValidForm as aa, isValidField as ab, isValidArrayOfFields as ac, validateJSONForm as ad, formHasComponents as ae, isValidTime as af, omitFields as ag, someFields as ah, FRAMEWORKS as ai, FRAMEWORKS_LABELS as aj, FIELDS_KEY as ak, LfField as al, LfGroup as am, LfObject as an, LfColumns as ao, LfColumn as ap, LfArray as aq, LfTabs as ar, LfTab as as, LfSteps as at, LfStep as au, traverseChildren as av, index as aw, makeWidthStyle as b, _isString as c, _omit as d, _objectSpread2 as e, filterOptions as f, _isArray as g, _slicedToArray as h, i18nOptions as i, _toConsumableArray as j, ThreeColumns as k, lfLog as l, makeClassName as m, lazyPreload as n, GenerateGenerator as o, passRest as p, classNames as q, ChevronUp as r, styleInject as s, ChevronDown as t, useFormContext as u, _isDate as v, isValidDate as w, _isEmpty as x, _defineProperty$1 as y, _isFunction as z };
