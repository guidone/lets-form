...
var Fields = {
  'input-text': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BXLEMypr.js');
    })
  },
  'input-number': {
    'react-mantine': lazyPreload(function () {
      return import('./index-ZQOQFn76.js');
    })
  },
  'textarea': {
    'react-mantine': lazyPreload(function () {
      return import('./index-Dw_VKSDE.js');
    })
  },
  'select': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DjsDx-VV.js');
    })
  },
  'checkbox': {
    'react-mantine': lazyPreload(function () {
      return import('./index-YNy903SJ.js');
    })
  },
  'toggle': {
    'react-mantine': lazyPreload(function () {
      return import('./index-ClrnW5i8.js');
    })
  },
  'array': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BS99idRQ.js');
    })
  },
  'checkbox-group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-1zAtEl07.js');
    })
  },
  'radio-group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BRBkZ3Vb.js');
    })
  },
  'two-columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-C1OdcUwn.js');
    })
  },
  'three-columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-D7DP3H2p.js');
    })
  },
  'group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BvSYfKxn.js');
    })
  },
  'date': {
    'react-mantine': lazyPreload(function () {
      return import('./index-D_fn-DCZ.js');
    })
  },
  'datetime': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CgbvqXDn.js');
    })
  },
  'rate': {
    'react-mantine': lazyPreload(function () {
      return import('./index-Du3aNYwY.js');
    })
  },
  'placeholder': {
    'react-mantine': lazyPreload(function () {
      return import('./index-HiUNkk2A.js');
    })
  },
  'divider': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DWfzS77C.js');
    })
  },
  'slider': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DjID4b8B.js');
    })
  },
  'input-tag': {
    'react-mantine': lazyPreload(function () {
      return import('./index-Cmfka0V6.js');
    })
  },
  'tabs': {
    'react-mantine': lazyPreload(function () {
      return import('./index-Cpv4TnGq.js');
    })
  }
};
var Forms = {
  'react-mantine': lazyPreload(function () {
    return import('./index-CwlrVTDh.js');
  })
};
...
export { isI18n as $, _objectDestructuringEmpty as A, _objectSpread2 as B, isUrl as C, styleInject as D, Forms as E, Fields as F, Group as G, replaceField as H, I18N as I, mapFields as J, deleteField as K, LetsForm as L, cleanUp as M, addField as N, findField as O, createEmptyField as P, reduceFields as Q, getFieldById as R, applyFormRules as S, TwoColumns as T, validateRulesDefinition as U, isValidDayjsFormat as V, filterFields as W, getLocales as X, i18n as Y, isEmptyForm as Z, _objectWithoutProperties as _, _extends as a, applyTransformers as a0, formHelper as a1, collectIds as a2, isChildrenOf as a3, validateJSONForm as a4, formHasComponents as a5, FRAMEWORKS as a6, FRAMEWORKS_LABELS as a7, FIELDS_KEY as a8, _isString as b, _castSlice as c, _hasUnicode as d, _stringToArray as e, filterOptions as f, getDefaultExportFromCjs as g, _isNumber as h, i18nOptions as i, _defineProperty$1 as j, classNames as k, lfLog as l, makeWidthStyle as m, _slicedToArray as n, _toConsumableArray as o, passRest as p, _isArray as q, _omit as r, collectNames as s, toString_1 as t, useFormContext as u, _isEmpty as v, fillIds as w, ThreeColumns as x, _isDate as y, isValidDate as z };
