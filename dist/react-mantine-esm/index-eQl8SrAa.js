/* LetsForm react-mantine v0.9.5 - ESM */
...
var Fields = {
  'input-text': {
    'react-mantine': lazyPreload(function () {
      return import('./index-6gLQhKi1.js');
    })
  },
  'input-number': {
    'react-mantine': lazyPreload(function () {
      return import('./index-B0MnBn0o.js');
    })
  },
  'textarea': {
    'react-mantine': lazyPreload(function () {
      return import('./index-ngoH7KqN.js');
    })
  },
  'select': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CzTCavtD.js');
    })
  },
  'checkbox': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BnlNBn0n.js');
    })
  },
  'toggle': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BC4mPJX6.js');
    })
  },
  'array': {
    'react-mantine': lazyPreload(function () {
      return import('./index-B54i1skH.js');
    })
  },
  'checkbox-group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-qGsqORhE.js');
    })
  },
  'radio-group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-C9W5nSQK.js');
    })
  },
  'two-columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-oJMFAd9n.js');
    })
  },
  'three-columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DYKbJWaK.js');
    })
  },
  'group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-Clmd8__F.js');
    })
  },
  'date': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BtQ8Eg7z.js');
    })
  },
  'datetime': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DmbGahUx.js');
    })
  },
  'rate': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CPMtTEfG.js');
    })
  },
  'placeholder': {
    'react-mantine': lazyPreload(function () {
      return import('./index-Bt8eHOcI.js');
    })
  },
  'placeholder-image': {
    'react-mantine': lazyPreload(function () {
      return import('./index-Bt7rpkPh.js');
    })
  },
  'divider': {
    'react-mantine': lazyPreload(function () {
  ...
  'slider': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DEgasrxI.js');
    })
  },
  'input-tag': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BdIvCiQu.js');
    })
  },
  'tabs': {
    'react-mantine': lazyPreload(function () {
      return import('./index-1e5ORq4b.js');
    })
  },
  'button': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BDU8cmpf.js');
    })
  },
  'upload': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BGsxPfvB.js');
    })
  },
  'multiselect': {
    'react-mantine': lazyPreload(function () {
      return import('./index-C2Ljkyri.js');
    })
  },
  'steps': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CoW_timA.js');
    })
  },
  'time': {
    'react-mantine': lazyPreload(function () {
      return import('./index-B9aievfm.js');
    })
  },
  'hidden': {
    'react-mantine': lazyPreload(function () {
      return import('./index-w7VTVrjf.js');
    })
  }
};
var Forms = {
  'react-mantine': lazyPreload(function () {
    return import('./index-COD-Gatr.js');
  })
};
...
export { isI18n as $, _objectSpread2 as A, isUrl as B, styleInject as C, _isFunction as D, Forms as E, Fields as F, Group as G, Connectors as H, I18N as I, replaceField as J, mapFields as K, LetsForm as L, deleteField as M, cleanUp as N, addField as O, findField as P, createEmptyField as Q, reduceFields as R, getFieldById as S, TwoColumns as T, applyFormRules as U, isValidDayjsFormat as V, filterFields as W, getLocales as X, i18n as Y, isEmptyForm as Z, _objectWithoutProperties as _, _extends as a, applyTransformers as a0, formHelper as a1, collectIds as a2, isChildrenOf as a3, isValidConnector as a4, isValidForm as a5, isValidField as a6, isValidArrayOfFields as a7, validateJSONForm as a8, formHasComponents as a9, isValidTime as aa, omitFields as ab, FRAMEWORKS as ac, FRAMEWORKS_LABELS as ad, FIELDS_KEY as ae, LfField as af, LfGroup as ag, LfColumns as ah, LfColumn as ai, LfArray as aj, LfTabs as ak, LfTab as al, LfSteps as am, LfStep as an, traverseChildren as ao, _isString as b, _castSlice as c, _hasUnicode as d, _stringToArray as e, filterOptions as f, getDefaultExportFromCjs as g, _isNumber as h, i18nOptions as i, _defineProperty$1 as j, classNames as k, lfLog as l, makeWidthStyle as m, _slicedToArray as n, _toConsumableArray as o, passRest as p, _isArray as q, _omit as r, collectNames as s, toString_1 as t, useFormContext as u, _isEmpty as v, fillIds as w, ThreeColumns as x, _isDate as y, isValidDate as z };
