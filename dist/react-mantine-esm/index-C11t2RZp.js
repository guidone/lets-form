/* LetsForm react-mantine v0.12.16 - ESM */
...
var Fields = {
  'input-text': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CEtIYOEK.js');
    })
  },
  'input-number': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DAF0mshy.js');
    })
  },
  'textarea': {
    'react-mantine': lazyPreload(function () {
      return import('./index-srnWyQOk.js');
    })
  },
  'select': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CEAm54GE.js');
    })
  },
  'checkbox': {
    'react-mantine': lazyPreload(function () {
      return import('./index-gOSAuzPD.js');
    })
  },
  'toggle': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DxlMomvs.js');
    })
  },
  'array': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DU1dnljj.js');
    })
  },
  'checkbox-group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CsEVFZSQ.js');
    })
  },
  'radio-group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-qk1a0S8T.js');
    })
  },
  'two-columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-0ZQbQXPi.js');
    })
  },
  'three-columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CeB-zyt8.js');
    })
  },
  'columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CPEn45_g.js');
    })
  },
  'group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DebALMQi.js');
    })
  },
  'date': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CaZUmaSX.js');
    })
  },
  'datetime': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CpIAXYmD.js');
    })
  },
  'rate': {
    'react-mantine': lazyPreload(function () {
      return import('./index-B9MSDB6Z.js');
    })
  },
  'placeholder': {
    'react-mantine': lazyPreload(function () {
      return import('./index-Cb2mdPaJ.js');
    })
  },
  'placeholder-image': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DrcSgZFy.js');
    })
  },
  'divider': {
    'react-mantine': lazyPreload(function () {
  ...
  'slider': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BOp8NJh1.js');
    })
  },
  'input-tag': {
    'react-mantine': lazyPreload(function () {
      return import('./index-Bvn6dR6k.js');
    })
  },
  'tabs': {
    'react-mantine': lazyPreload(function () {
      return import('./index-C49ehu1y.js');
    })
  },
  'button': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CseIb5aN.js');
    })
  },
  'upload': {
    'react-mantine': lazyPreload(function () {
      return import('./index-B_49u4HK.js');
    })
  },
  'multiselect': {
    'react-mantine': lazyPreload(function () {
      return import('./index-Byk9aXIm.js');
    })
  },
  'steps': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BybfyyJE.js');
    })
  },
  'time': {
    'react-mantine': lazyPreload(function () {
      return import('./index-xI05rSPr.js');
    })
  },
  'hidden': {
    'react-mantine': lazyPreload(function () {
      return import('./index-D13otOUv.js');
    })
  },
  'currency': {
    'react-mantine': lazyPreload(function () {
      return import('./index-D8wuk1R2.js');
    })
  }
};
var Forms = {
  'react-mantine': lazyPreload(function () {
    return import('./index-DFNvaQHs.js');
  })
};
...
export { isI18n as $, _isDate as A, isValidDate as B, Columns as C, isUrl as D, styleInject as E, _isFunction as F, Group as G, lfWarn as H, I18N as I, Fields as J, Forms as K, LetsForm as L, Connectors as M, replaceField as N, mapFields as O, cleanUp as P, findField as Q, reduceFields as R, getFieldById as S, TwoColumns as T, applyFormRules as U, isValidDayjsFormat as V, filterFields as W, getLocales as X, i18n as Y, isEmptyForm as Z, _objectWithoutProperties as _, _extends as a, applyTransformers as a0, formHelper as a1, collectIds as a2, isChildrenOf as a3, isValidConnector as a4, isValidForm as a5, isValidField as a6, isValidArrayOfFields as a7, validateJSONForm as a8, formHasComponents as a9, isValidTime as aa, omitFields as ab, someFields as ac, FRAMEWORKS as ad, FRAMEWORKS_LABELS as ae, FIELDS_KEY as af, LfField as ag, LfGroup as ah, LfColumns as ai, LfColumn as aj, LfArray as ak, LfTabs as al, LfTab as am, LfSteps as an, LfStep as ao, traverseChildren as ap, makeWidthStyle as b, _isString as c, _omit as d, _objectSpread2 as e, filterOptions as f, _castSlice as g, _hasUnicode as h, i18nOptions as i, _stringToArray as j, getDefaultExportFromCjs as k, lfLog as l, makeClassName as m, _isNumber as n, _defineProperty$1 as o, passRest as p, classNames as q, _slicedToArray as r, _toConsumableArray as s, toString_1 as t, useFormContext as u, _isArray as v, collectNames as w, _isEmpty as x, fillIds as y, ThreeColumns as z };
