...
var Fields = {
  'input-text': {
    'react-mantine': lazyPreload(function () {
      return import('./index-C3CzZ7RN.js');
    })
  },
  'input-number': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BMlBxJoC.js');
    })
  },
  'textarea': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CgnZ3f8t.js');
    })
  },
  'select': {
    'react-mantine': lazyPreload(function () {
      return import('./index-Al7wXaC2.js');
    })
  },
  'checkbox': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CZVoy_Id.js');
    })
  },
  'toggle': {
    'react-mantine': lazyPreload(function () {
      return import('./index-6lcvdQKW.js');
    })
  },
  'array': {
    'react-mantine': lazyPreload(function () {
      return import('./index-C0xBWTA8.js');
    })
  },
  'checkbox-group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DJT-5aGl.js');
    })
  },
  'radio-group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DMuHhlqY.js');
    })
  },
  'two-columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-zn6R_qn7.js');
    })
  },
  'three-columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DFWvWOhU.js');
    })
  },
  'group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-PkPIhW1b.js');
    })
  },
  'date': {
    'react-mantine': lazyPreload(function () {
      return import('./index-N4PEJqCO.js');
    })
  },
  'datetime': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DVVYlNu8.js');
    })
  },
  'rate': {
    'react-mantine': lazyPreload(function () {
      return import('./index-B3ylEpv2.js');
    })
  },
  'placeholder': {
    'react-mantine': lazyPreload(function () {
      return import('./index-_--yasAs.js');
    })
  },
  'divider': {
    'react-mantine': lazyPreload(function () {
      return import('./index-C-GgE_rt.js');
    })
  },
  'slider': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CLfBM7Hz.js');
    })
  },
  'input-tag': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CZlXCKBc.js');
    })
  },
  'tabs': {
    'react-mantine': lazyPreload(function () {
      return import('./index-D1fdF2fX.js');
    })
  }
};
var Forms = {
  'react-mantine': lazyPreload(function () {
    return import('./index-Bkvc-gV7.js');
  })
};
