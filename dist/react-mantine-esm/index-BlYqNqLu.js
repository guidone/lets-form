/* LetsForm react-mantine v0.7.13-beta-9 - ESM */
...
var Fields = {
  'input-text': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BHJ44E6F.js');
    })
  },
  'input-number': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BrNzQTNm.js');
    })
  },
  'textarea': {
    'react-mantine': lazyPreload(function () {
      return import('./index-C_zt7u-Y.js');
    })
  },
  'select': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CeSNAcuB.js');
    })
  },
  'checkbox': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CU_74Smd.js');
    })
  },
  'toggle': {
    'react-mantine': lazyPreload(function () {
      return import('./index-B1IJJ_lx.js');
    })
  },
  'array': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BrSneJM8.js');
    })
  },
  'checkbox-group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CCOywPfs.js');
    })
  },
  'radio-group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CnACjw4H.js');
    })
  },
  'two-columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-D-l9Sd6A.js');
    })
  },
  'three-columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CR0PIuNg.js');
    })
  },
  'group': {
    'react-mantine': lazyPreload(function () {
      return import('./index--iGRqfHT.js');
    })
  },
  'date': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BL0QRpL5.js');
    })
  },
  'datetime': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DOIaFjn9.js');
    })
  },
  'rate': {
    'react-mantine': lazyPreload(function () {
      return import('./index-C2cdjYyY.js');
    })
  },
  'placeholder': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CSBU7tQk.js');
    })
  },
  'placeholder-image': {
    'react-mantine': lazyPreload(function () {
      return import('./index-MvMZ7tW_.js');
    })
  },
  'divider': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DFsfzuCH.js');
    })
  },
  'slider': {
    'react-mantine': lazyPreload(function () {
      return import('./index-0YGKlZh1.js');
    })
  },
  'input-tag': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DsL1dwaO.js');
    })
  },
  'tabs': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BYtT7-Sv.js');
    })
  },
  'button': {
    'react-mantine': lazyPreload(function () {
      return import('./index-B64u6gNJ.js');
    })
  },
  'upload': {
    'react-mantine': lazyPreload(function () {
      return import('./index-C_Bucsiz.js');
    })
  },
  'multiselect': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CVMK0xbt.js');
    })
  }
};
var Forms = {
  'react-mantine': lazyPreload(function () {
    return import('./index-ACxneOot.js');
  })
};
