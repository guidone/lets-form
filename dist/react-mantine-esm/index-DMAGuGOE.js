/* LetsForm react-mantine v0.12.15 - ESM */
...
var Fields = {
  'input-text': {
    'react-mantine': lazyPreload(function () {
      return import('./index-xhoQpMAN.js');
    })
  },
  'input-number': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BLYlHQyE.js');
    })
  },
  'textarea': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CI81YzGS.js');
    })
  },
  'select': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DAja5Lxl.js');
    })
  },
  'checkbox': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BFSZirD6.js');
    })
  },
  'toggle': {
    'react-mantine': lazyPreload(function () {
      return import('./index-FuV_Sq5h.js');
    })
  },
  'array': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CWZubOq-.js');
    })
  },
  'checkbox-group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CKRYV177.js');
    })
  },
  'radio-group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-hay4wVW9.js');
    })
  },
  'two-columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-4AEHF0bJ.js');
    })
  },
  'three-columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-D6OMFOmw.js');
    })
  },
  'columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-Dh9tfOGw.js');
    })
  },
  'group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DC9dQtmN.js');
    })
  },
  'date': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BfHj_FJd.js');
    })
  },
  'datetime': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BdmhXuXC.js');
    })
  },
  'rate': {
    'react-mantine': lazyPreload(function () {
      return import('./index-RpreRF_u.js');
    })
  },
  'placeholder': {
    'react-mantine': lazyPreload(function () {
      return import('./index-y9gqo7bG.js');
    })
  },
  'placeholder-image': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CsspHKlm.js');
    })
  },
  'divider': {
    'react-mantine': lazyPreload(function () {
  ...
  'slider': {
    'react-mantine': lazyPreload(function () {
      return import('./index-C24lgV7x.js');
    })
  },
  'input-tag': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BC_lfuDo.js');
    })
  },
  'tabs': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CYP14RvT.js');
    })
  },
  'button': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DDEgDaQo.js');
    })
  },
  'upload': {
    'react-mantine': lazyPreload(function () {
      return import('./index-RkuCC-Qg.js');
    })
  },
  'multiselect': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DZnw_Cre.js');
    })
  },
  'steps': {
    'react-mantine': lazyPreload(function () {
      return import('./index-B0VDcpR4.js');
    })
  },
  'time': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BubOjh9x.js');
    })
  },
  'hidden': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DX0g-smJ.js');
    })
  },
  'currency': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CBKZA_Jx.js');
    })
  }
};
var Forms = {
  'react-mantine': lazyPreload(function () {
    return import('./index-DKgKYrff.js');
  })
};
...
export { applyTransformers as $, _isDate as A, isValidDate as B, Columns as C, isUrl as D, styleInject as E, _isFunction as F, Group as G, Fields as H, I18N as I, Forms as J, Connectors as K, LetsForm as L, replaceField as M, mapFields as N, cleanUp as O, findField as P, reduceFields as Q, getFieldById as R, applyFormRules as S, TwoColumns as T, isValidDayjsFormat as U, filterFields as V, getLocales as W, i18n as X, isEmptyForm as Y, isI18n as Z, _objectWithoutProperties as _, _extends as a, formHelper as a0, collectIds as a1, isChildrenOf as a2, isValidConnector as a3, isValidForm as a4, isValidField as a5, isValidArrayOfFields as a6, validateJSONForm as a7, formHasComponents as a8, isValidTime as a9, omitFields as aa, someFields as ab, FRAMEWORKS as ac, FRAMEWORKS_LABELS as ad, FIELDS_KEY as ae, LfField as af, LfGroup as ag, LfColumns as ah, LfColumn as ai, LfArray as aj, LfTabs as ak, LfTab as al, LfSteps as am, LfStep as an, traverseChildren as ao, makeWidthStyle as b, _isString as c, _omit as d, _objectSpread2 as e, filterOptions as f, _castSlice as g, _hasUnicode as h, i18nOptions as i, _stringToArray as j, getDefaultExportFromCjs as k, lfLog as l, makeClassName as m, _isNumber as n, _defineProperty$1 as o, passRest as p, classNames as q, _slicedToArray as r, _toConsumableArray as s, toString_1 as t, useFormContext as u, _isArray as v, collectNames as w, _isEmpty as x, fillIds as y, ThreeColumns as z };
