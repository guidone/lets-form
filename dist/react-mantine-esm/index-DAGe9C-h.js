/* LetsForm react-mantine v0.12.3 - ESM */
...
var Fields = {
  'input-text': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CkA4mLWa.js');
    })
  },
  'input-number': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CTJ0P9b3.js');
    })
  },
  'textarea': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CPQvl0ag.js');
    })
  },
  'select': {
    'react-mantine': lazyPreload(function () {
      return import('./index-C3NbgMSK.js');
    })
  },
  'checkbox': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CnbTq2DW.js');
    })
  },
  'toggle': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CD7Otesk.js');
    })
  },
  'array': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BvMasQjR.js');
    })
  },
  'checkbox-group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DUYR4s5S.js');
    })
  },
  'radio-group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CRvTZ5Dy.js');
    })
  },
  'two-columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CtpWvAlR.js');
    })
  },
  'three-columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CyU_gC7x.js');
    })
  },
  'columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-Bhj7IR01.js');
    })
  },
  'group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-_QV5OghP.js');
    })
  },
  'date': {
    'react-mantine': lazyPreload(function () {
      return import('./index-Dq31vtzT.js');
    })
  },
  'datetime': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BJx0_RcU.js');
    })
  },
  'rate': {
    'react-mantine': lazyPreload(function () {
      return import('./index-ObBTotFo.js');
    })
  },
  'placeholder': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CtHPW5Bc.js');
    })
  },
  'placeholder-image': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CiPMtJNz.js');
    })
  },
  'divider': {
    'react-mantine': lazyPreload(function () {
  ...
  'slider': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BrhjPg0a.js');
    })
  },
  'input-tag': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CkF-Swo1.js');
    })
  },
  'tabs': {
    'react-mantine': lazyPreload(function () {
      return import('./index-ahs7rMQx.js');
    })
  },
  'button': {
    'react-mantine': lazyPreload(function () {
      return import('./index-D4YY90Pr.js');
    })
  },
  'upload': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BydzR7xa.js');
    })
  },
  'multiselect': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DOzExNVc.js');
    })
  },
  'steps': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DTfX9ERS.js');
    })
  },
  'time': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BZM2GoUG.js');
    })
  },
  'hidden': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DQSYU34-.js');
    })
  }
};
var Forms = {
  'react-mantine': lazyPreload(function () {
    return import('./index-CN-KbmLL.js');
  })
};
...
export { formHelper as $, isValidDate as A, isUrl as B, Columns as C, styleInject as D, _isFunction as E, Fields as F, Group as G, Forms as H, I18N as I, Connectors as J, replaceField as K, LetsForm as L, mapFields as M, cleanUp as N, findField as O, reduceFields as P, getFieldById as Q, applyFormRules as R, isValidDayjsFormat as S, TwoColumns as T, filterFields as U, getLocales as V, i18n as W, isEmptyForm as X, isI18n as Y, applyTransformers as Z, _objectWithoutProperties as _, _extends as a, collectIds as a0, isChildrenOf as a1, isValidConnector as a2, isValidForm as a3, isValidField as a4, isValidArrayOfFields as a5, validateJSONForm as a6, formHasComponents as a7, isValidTime as a8, omitFields as a9, FRAMEWORKS as aa, FRAMEWORKS_LABELS as ab, FIELDS_KEY as ac, LfField as ad, LfGroup as ae, LfColumns as af, LfColumn as ag, LfArray as ah, LfTabs as ai, LfTab as aj, LfSteps as ak, LfStep as al, traverseChildren as am, _isString as b, _omit as c, _objectSpread2 as d, _castSlice as e, filterOptions as f, _hasUnicode as g, _stringToArray as h, i18nOptions as i, getDefaultExportFromCjs as j, _isNumber as k, lfLog as l, makeWidthStyle as m, _defineProperty$1 as n, classNames as o, passRest as p, _slicedToArray as q, _toConsumableArray as r, _isArray as s, toString_1 as t, useFormContext as u, collectNames as v, _isEmpty as w, fillIds as x, ThreeColumns as y, _isDate as z };
