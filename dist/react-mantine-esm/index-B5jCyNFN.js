/* LetsForm react-mantine v0.7.12 - ESM */
...
var Fields = {
  'input-text': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BsYRdfaA.js');
    })
  },
  'input-number': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BFkLIQ0_.js');
    })
  },
  'textarea': {
    'react-mantine': lazyPreload(function () {
      return import('./index-7THi66pg.js');
    })
  },
  'select': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DwzpJBiL.js');
    })
  },
  'checkbox': {
    'react-mantine': lazyPreload(function () {
      return import('./index-fjRmEYhy.js');
    })
  },
  'toggle': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DjQxLxz2.js');
    })
  },
  'array': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BFsAUsVM.js');
    })
  },
  'checkbox-group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-B1OqRHCh.js');
    })
  },
  'radio-group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-D3at6c00.js');
    })
  },
  'two-columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DZ0E9UeP.js');
    })
  },
  'three-columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-iAJpKJCJ.js');
    })
  },
  'group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-Do_XCDwi.js');
    })
  },
  'date': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CDekFyRm.js');
    })
  },
  'datetime': {
    'react-mantine': lazyPreload(function () {
      return import('./index-eC6ilCuu.js');
    })
  },
  'rate': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DNN-Sitp.js');
    })
  },
  'placeholder': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CtEmOKcH.js');
    })
  },
  'placeholder-image': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CI0SQq5m.js');
    })
  },
  'divider': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BMOtIK8X.js');
    })
  },
  'slider': {
    'react-mantine': lazyPreload(function () {
      return import('./index-68iQYx1P.js');
    })
  },
  'input-tag': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CdD5lQQz.js');
    })
  },
  'tabs': {
    'react-mantine': lazyPreload(function () {
      return import('./index-D8I3EAqz.js');
    })
  },
  'button': {
    'react-mantine': lazyPreload(function () {
      return import('./index-Bq-UpR4q.js');
    })
  },
  'upload': {
    'react-mantine': lazyPreload(function () {
      return import('./index-C-WBGS5j.js');
    })
  },
  'multiselect': {
    'react-mantine': lazyPreload(function () {
      return import('./index-C7fXgo8V.js');
    })
  }
};
var Forms = {
  'react-mantine': lazyPreload(function () {
    return import('./index-C8Ndxd87.js');
  })
};
