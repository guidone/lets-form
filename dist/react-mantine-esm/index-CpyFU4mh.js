/* LetsForm react-mantine v0.8.1 - ESM */
...
var Fields = {
  'input-text': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CD-DpCce.js');
    })
  },
  'input-number': {
    'react-mantine': lazyPreload(function () {
      return import('./index-IEH9CuOx.js');
    })
  },
  'textarea': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BXst921b.js');
    })
  },
  'select': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DxCgrIP3.js');
    })
  },
  'checkbox': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CT-a-tmJ.js');
    })
  },
  'toggle': {
    'react-mantine': lazyPreload(function () {
      return import('./index-hxB294RI.js');
    })
  },
  'array': {
    'react-mantine': lazyPreload(function () {
      return import('./index-Clco_LWC.js');
    })
  },
  'checkbox-group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-C2JBI8zz.js');
    })
  },
  'radio-group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BkpF7ffU.js');
    })
  },
  'two-columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-LfuvCRfL.js');
    })
  },
  'three-columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-C3gouC-1.js');
    })
  },
  'group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-8UnQgPHl.js');
    })
  },
  'date': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CRq3spsl.js');
    })
  },
  'datetime': {
    'react-mantine': lazyPreload(function () {
      return import('./index-B6ebqJE4.js');
    })
  },
  'rate': {
    'react-mantine': lazyPreload(function () {
      return import('./index-Rpo2Qpu1.js');
    })
  },
  'placeholder': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BupipGHY.js');
    })
  },
  'placeholder-image': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BBMUAfKK.js');
    })
  },
  'divider': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DUdpi_38.js');
    })
  },
  'slider': {
    'react-mantine': lazyPreload(function () {
      return import('./index-lX1XXiDJ.js');
    })
  },
  'input-tag': {
    'react-mantine': lazyPreload(function () {
      return import('./index-_5ojPwY6.js');
    })
  },
  'tabs': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CoHOlbyY.js');
    })
  },
  'button': {
    'react-mantine': lazyPreload(function () {
      return import('./index-Cf5xL1xT.js');
    })
  },
  'upload': {
    'react-mantine': lazyPreload(function () {
      return import('./index-D47F3Jex.js');
    })
  },
  'multiselect': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CVTMQs1E.js');
    })
  },
  'steps': {
    'react-mantine': lazyPreload(function () {
      return import('./index-HdrcIrVc.js');
    })
  },
  'time': {
    'react-mantine': lazyPreload(function () {
      return import('./index-B6MpYGqq.js');
    })
  },
  'hidden': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DjI5Lvkm.js');
    })
  }
};
var Forms = {
  'react-mantine': lazyPreload(function () {
    return import('./index-CB4zPW-p.js');
  })
};
