/* LetsForm react-mantine v0.12.13 - ESM */
...
var Fields = {
  'input-text': {
    'react-mantine': lazyPreload(function () {
      return import('./index-Cg6_3EU7.js');
    })
  },
  'input-number': {
    'react-mantine': lazyPreload(function () {
      return import('./index-B6Rz9r8w.js');
    })
  },
  'textarea': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BNH7JwQf.js');
    })
  },
  'select': {
    'react-mantine': lazyPreload(function () {
      return import('./index-B4VR90V1.js');
    })
  },
  'checkbox': {
    'react-mantine': lazyPreload(function () {
      return import('./index-D4jW44sf.js');
    })
  },
  'toggle': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DF_0s4vD.js');
    })
  },
  'array': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CMyGQZ8X.js');
    })
  },
  'checkbox-group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-Bl6LLN-o.js');
    })
  },
  'radio-group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-D9O4s0bp.js');
    })
  },
  'two-columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BzaeZXH7.js');
    })
  },
  'three-columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-Dnrvi_M-.js');
    })
  },
  'columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-B3SilMPS.js');
    })
  },
  'group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BDqk1ypo.js');
    })
  },
  'date': {
    'react-mantine': lazyPreload(function () {
      return import('./index-g26U5Ydw.js');
    })
  },
  'datetime': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CZSCiOgx.js');
    })
  },
  'rate': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BGfxb03k.js');
    })
  },
  'placeholder': {
    'react-mantine': lazyPreload(function () {
      return import('./index-OcylG85v.js');
    })
  },
  'placeholder-image': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CFGqsA1a.js');
    })
  },
  'divider': {
    'react-mantine': lazyPreload(function () {
  ...
  'slider': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BNmxFAln.js');
    })
  },
  'input-tag': {
    'react-mantine': lazyPreload(function () {
      return import('./index-84bJdSgJ.js');
    })
  },
  'tabs': {
    'react-mantine': lazyPreload(function () {
      return import('./index-B4wj1kSn.js');
    })
  },
  'button': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CqCDzdVk.js');
    })
  },
  'upload': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DeE_MyUb.js');
    })
  },
  'multiselect': {
    'react-mantine': lazyPreload(function () {
      return import('./index-C4U4J2Jg.js');
    })
  },
  'steps': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BtCkUQF6.js');
    })
  },
  'time': {
    'react-mantine': lazyPreload(function () {
      return import('./index-D9Ml5e5p.js');
    })
  },
  'hidden': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DlpdTJdg.js');
    })
  },
  'currency': {
    'react-mantine': lazyPreload(function () {
      return import('./index-S5yIQzVH.js');
    })
  }
};
var Forms = {
  'react-mantine': lazyPreload(function () {
    return import('./index-Bc-9gp2t.js');
  })
};
