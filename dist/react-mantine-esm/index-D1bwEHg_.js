/* LetsForm react-mantine v0.11.2 - ESM */
...
var Fields = {
  'input-text': {
    'react-mantine': lazyPreload(function () {
      return import('./index-D96REakX.js');
    })
  },
  'input-number': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DlYs1huQ.js');
    })
  },
  'textarea': {
    'react-mantine': lazyPreload(function () {
      return import('./index-Yehm1GJ_.js');
    })
  },
  'select': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BtYeDDWd.js');
    })
  },
  'checkbox': {
    'react-mantine': lazyPreload(function () {
      return import('./index-O-rQObUP.js');
    })
  },
  'toggle': {
    'react-mantine': lazyPreload(function () {
      return import('./index-qL2eBtzK.js');
    })
  },
  'array': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BizfS3_r.js');
    })
  },
  'checkbox-group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CuunF_1D.js');
    })
  },
  'radio-group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-Bor3fwUX.js');
    })
  },
  'two-columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-F450Iuc2.js');
    })
  },
  'three-columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BZ0kjaRZ.js');
    })
  },
  'columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BQ7PWzvX.js');
    })
  },
  'group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-des5FlNQ.js');
    })
  },
  'date': {
    'react-mantine': lazyPreload(function () {
      return import('./index-B0FaVmkG.js');
    })
  },
  'datetime': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DRBfleIt.js');
    })
  },
  'rate': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DKt9qWTU.js');
    })
  },
  'placeholder': {
    'react-mantine': lazyPreload(function () {
      return import('./index-C-ChxNir.js');
    })
  },
  'placeholder-image': {
    'react-mantine': lazyPreload(function () {
      return import('./index-Dg8R1c3e.js');
    })
  },
  'divider': {
    'react-mantine': lazyPreload(function () {
  ...
  'slider': {
    'react-mantine': lazyPreload(function () {
      return import('./index-D1XU1U8l.js');
    })
  },
  'input-tag': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CmRx_z8R.js');
    })
  },
  'tabs': {
    'react-mantine': lazyPreload(function () {
      return import('./index-U6YWbLgW.js');
    })
  },
  'button': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CK_D7AFw.js');
    })
  },
  'upload': {
    'react-mantine': lazyPreload(function () {
      return import('./index-3uqPQ5w_.js');
    })
  },
  'multiselect': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BJiyyIop.js');
    })
  },
  'steps': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CBm2d6ez.js');
    })
  },
  'time': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DBTQtX6X.js');
    })
  },
  'hidden': {
    'react-mantine': lazyPreload(function () {
      return import('./index-D-YVz7E1.js');
    })
  }
};
var Forms = {
  'react-mantine': lazyPreload(function () {
    return import('./index-XKn5nPtB.js');
  })
};
...
export { i18n as $, isValidDate as A, isUrl as B, Columns as C, styleInject as D, _isFunction as E, Fields as F, Group as G, Forms as H, I18N as I, Connectors as J, replaceField as K, LetsForm as L, mapFields as M, deleteField as N, cleanUp as O, addField as P, AddFieldAfter as Q, findField as R, createEmptyField as S, TwoColumns as T, reduceFields as U, getFieldById as V, applyFormRules as W, isValidDayjsFormat as X, filterFields as Y, getLocales as Z, _objectWithoutProperties as _, _extends as a, isEmptyForm as a0, isI18n as a1, applyTransformers as a2, formHelper as a3, collectIds as a4, isChildrenOf as a5, isValidConnector as a6, isValidForm as a7, isValidField as a8, isValidArrayOfFields as a9, validateJSONForm as aa, formHasComponents as ab, isValidTime as ac, omitFields as ad, FRAMEWORKS as ae, FRAMEWORKS_LABELS as af, FIELDS_KEY as ag, LfField as ah, LfGroup as ai, LfColumns as aj, LfColumn as ak, LfArray as al, LfTabs as am, LfTab as an, LfSteps as ao, LfStep as ap, traverseChildren as aq, _isString as b, _omit as c, _objectSpread2 as d, _castSlice as e, filterOptions as f, _hasUnicode as g, _stringToArray as h, i18nOptions as i, getDefaultExportFromCjs as j, _isNumber as k, lfLog as l, makeWidthStyle as m, _defineProperty$1 as n, classNames as o, passRest as p, _slicedToArray as q, _toConsumableArray as r, _isArray as s, toString_1 as t, useFormContext as u, collectNames as v, _isEmpty as w, fillIds as x, ThreeColumns as y, _isDate as z };
