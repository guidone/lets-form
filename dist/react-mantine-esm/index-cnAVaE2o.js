/* LetsForm react-mantine v0.10.5 - ESM */
...
var Fields = {
  'input-text': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CMFrYjUd.js');
    })
  },
  'input-number': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BQrbOqjl.js');
    })
  },
  'textarea': {
    'react-mantine': lazyPreload(function () {
      return import('./index-Agckn8P1.js');
    })
  },
  'select': {
    'react-mantine': lazyPreload(function () {
      return import('./index-jFiXu-We.js');
    })
  },
  'checkbox': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DCqRf3jf.js');
    })
  },
  'toggle': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BxnzDZeQ.js');
    })
  },
  'array': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BXJ1KYUY.js');
    })
  },
  'checkbox-group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DTmOAhxv.js');
    })
  },
  'radio-group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BybIxyWU.js');
    })
  },
  'two-columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CWHY26xX.js');
    })
  },
  'three-columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DpoRMYQb.js');
    })
  },
  'columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CTik2_il.js');
    })
  },
  'group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BKc-KMvC.js');
    })
  },
  'date': {
    'react-mantine': lazyPreload(function () {
      return import('./index-D5ANVyF1.js');
    })
  },
  'datetime': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CFOlwiK6.js');
    })
  },
  'rate': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BpSc69Lj.js');
    })
  },
  'placeholder': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BNkn41En.js');
    })
  },
  'placeholder-image': {
    'react-mantine': lazyPreload(function () {
      return import('./index-1-UERaJH.js');
    })
  },
  'divider': {
    'react-mantine': lazyPreload(function () {
  ...
  'slider': {
    'react-mantine': lazyPreload(function () {
      return import('./index-C07EkfZ5.js');
    })
  },
  'input-tag': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BpscEXT7.js');
    })
  },
  'tabs': {
    'react-mantine': lazyPreload(function () {
      return import('./index-B7a5pI7Z.js');
    })
  },
  'button': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DjmORUXJ.js');
    })
  },
  'upload': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CrPu1L0p.js');
    })
  },
  'multiselect': {
    'react-mantine': lazyPreload(function () {
      return import('./index-Cio2KiNR.js');
    })
  },
  'steps': {
    'react-mantine': lazyPreload(function () {
      return import('./index-cCRyfNVl.js');
    })
  },
  'time': {
    'react-mantine': lazyPreload(function () {
      return import('./index-KHmNsPpO.js');
    })
  },
  'hidden': {
    'react-mantine': lazyPreload(function () {
      return import('./index-_5Q2xvet.js');
    })
  }
};
var Forms = {
  'react-mantine': lazyPreload(function () {
    return import('./index-IimzEUH6.js');
  })
};
...
export { isEmptyForm as $, _objectSpread2 as A, isUrl as B, Columns as C, styleInject as D, _isFunction as E, Fields as F, Group as G, Forms as H, I18N as I, Connectors as J, replaceField as K, LetsForm as L, mapFields as M, deleteField as N, cleanUp as O, addField as P, findField as Q, createEmptyField as R, reduceFields as S, TwoColumns as T, getFieldById as U, applyFormRules as V, isValidDayjsFormat as W, filterFields as X, getLocales as Y, i18n as Z, _objectWithoutProperties as _, _extends as a, isI18n as a0, applyTransformers as a1, formHelper as a2, collectIds as a3, isChildrenOf as a4, isValidConnector as a5, isValidForm as a6, isValidField as a7, isValidArrayOfFields as a8, validateJSONForm as a9, formHasComponents as aa, isValidTime as ab, omitFields as ac, FRAMEWORKS as ad, FRAMEWORKS_LABELS as ae, FIELDS_KEY as af, LfField as ag, LfGroup as ah, LfColumns as ai, LfColumn as aj, LfArray as ak, LfTabs as al, LfTab as am, LfSteps as an, LfStep as ao, traverseChildren as ap, _isString as b, _omit as c, _castSlice as d, _hasUnicode as e, filterOptions as f, _stringToArray as g, getDefaultExportFromCjs as h, i18nOptions as i, _isNumber as j, _defineProperty$1 as k, lfLog as l, makeWidthStyle as m, classNames as n, _slicedToArray as o, passRest as p, _toConsumableArray as q, _isArray as r, collectNames as s, toString_1 as t, useFormContext as u, _isEmpty as v, fillIds as w, ThreeColumns as x, _isDate as y, isValidDate as z };
