/* LetsForm react-mantine v0.10.6 - ESM */
...
var Fields = {
  'input-text': {
    'react-mantine': lazyPreload(function () {
      return import('./index-KGFqCDLe.js');
    })
  },
  'input-number': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BUWgYR5t.js');
    })
  },
  'textarea': {
    'react-mantine': lazyPreload(function () {
      return import('./index-qUlW-DiL.js');
    })
  },
  'select': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DcKam7_0.js');
    })
  },
  'checkbox': {
    'react-mantine': lazyPreload(function () {
      return import('./index-Bn4GReon.js');
    })
  },
  'toggle': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BbUnjOnr.js');
    })
  },
  'array': {
    'react-mantine': lazyPreload(function () {
      return import('./index-x2hOhia9.js');
    })
  },
  'checkbox-group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DYpWsWk0.js');
    })
  },
  'radio-group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-Cg5ZYJxd.js');
    })
  },
  'two-columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-Bp48nX4o.js');
    })
  },
  'three-columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CkKj735E.js');
    })
  },
  'columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-D4sCK0Lx.js');
    })
  },
  'group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-C6kjkHTQ.js');
    })
  },
  'date': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DazUyg4T.js');
    })
  },
  'datetime': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CTtkrTfm.js');
    })
  },
  'rate': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DL_3hJck.js');
    })
  },
  'placeholder': {
    'react-mantine': lazyPreload(function () {
      return import('./index-t3QDOIOf.js');
    })
  },
  'placeholder-image': {
    'react-mantine': lazyPreload(function () {
      return import('./index-D_ddbASI.js');
    })
  },
  'divider': {
    'react-mantine': lazyPreload(function () {
  ...
  'slider': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DQxUi9Y1.js');
    })
  },
  'input-tag': {
    'react-mantine': lazyPreload(function () {
      return import('./index-GURN1R8T.js');
    })
  },
  'tabs': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DsIxnZ-D.js');
    })
  },
  'button': {
    'react-mantine': lazyPreload(function () {
      return import('./index-5DXkuLVv.js');
    })
  },
  'upload': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BtHA_8BL.js');
    })
  },
  'multiselect': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CrvbTn7A.js');
    })
  },
  'steps': {
    'react-mantine': lazyPreload(function () {
      return import('./index-TuRTf5j_.js');
    })
  },
  'time': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DG_DWITl.js');
    })
  },
  'hidden': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CJxEUHWB.js');
    })
  }
};
var Forms = {
  'react-mantine': lazyPreload(function () {
    return import('./index-Bn8e9Opf.js');
  })
};
...
export { isEmptyForm as $, isValidDate as A, isUrl as B, Columns as C, styleInject as D, _isFunction as E, Fields as F, Group as G, Forms as H, I18N as I, Connectors as J, replaceField as K, LetsForm as L, mapFields as M, deleteField as N, cleanUp as O, addField as P, findField as Q, createEmptyField as R, reduceFields as S, TwoColumns as T, getFieldById as U, applyFormRules as V, isValidDayjsFormat as W, filterFields as X, getLocales as Y, i18n as Z, _objectWithoutProperties as _, _extends as a, isI18n as a0, applyTransformers as a1, formHelper as a2, collectIds as a3, isChildrenOf as a4, isValidConnector as a5, isValidForm as a6, isValidField as a7, isValidArrayOfFields as a8, validateJSONForm as a9, formHasComponents as aa, isValidTime as ab, omitFields as ac, FRAMEWORKS as ad, FRAMEWORKS_LABELS as ae, FIELDS_KEY as af, LfField as ag, LfGroup as ah, LfColumns as ai, LfColumn as aj, LfArray as ak, LfTabs as al, LfTab as am, LfSteps as an, LfStep as ao, traverseChildren as ap, _isString as b, _omit as c, _objectSpread2 as d, _castSlice as e, filterOptions as f, _hasUnicode as g, _stringToArray as h, i18nOptions as i, getDefaultExportFromCjs as j, _isNumber as k, lfLog as l, makeWidthStyle as m, _defineProperty$1 as n, classNames as o, passRest as p, _slicedToArray as q, _toConsumableArray as r, _isArray as s, toString_1 as t, useFormContext as u, collectNames as v, _isEmpty as w, fillIds as x, ThreeColumns as y, _isDate as z };
