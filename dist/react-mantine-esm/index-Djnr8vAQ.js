...
var Fields = {
  'input-text': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DOxLctVB.js');
    })
  },
  'input-number': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DeFgdcSW.js');
    })
  },
  'textarea': {
    'react-mantine': lazyPreload(function () {
      return import('./index-drmpgwjn.js');
    })
  },
  'select': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DiN7l5QL.js');
    })
  },
  'checkbox': {
    'react-mantine': lazyPreload(function () {
      return import('./index-iFSwn5Tx.js');
    })
  },
  'toggle': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BkPEOxDo.js');
    })
  },
  'array': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DtvoqI70.js');
    })
  },
  'checkbox-group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DiVPbCoP.js');
    })
  },
  'radio-group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-dN61Lfpe.js');
    })
  },
  'two-columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-D_vAs1lD.js');
    })
  },
  'three-columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-Dwu5wLr-.js');
    })
  },
  'columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-XCdiUgIG.js');
    })
  },
  'group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-B0LqpbL0.js');
    })
  },
  'date': {
    'react-mantine': lazyPreload(function () {
      return import('./index-C_hq2Tiq.js');
    })
  },
  'datetime': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BKLGk2T_.js');
    })
  },
  'rate': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BQ_8LqOf.js');
    })
  },
  'placeholder': {
    'react-mantine': lazyPreload(function () {
      return import('./index-ZCg_INrH.js');
    })
  },
  'placeholder-image': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CpzOaiYD.js');
    })
  },
  'divider': {
    'react-mantine': lazyPreload(function () {
  ...
  'slider': {
    'react-mantine': lazyPreload(function () {
      return import('./index-D3rPreFA.js');
    })
  },
  'input-tag': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BGhIz28Y.js');
    })
  },
  'tabs': {
    'react-mantine': lazyPreload(function () {
      return import('./index-T2eQgn_f.js');
    })
  },
  'button': {
    'react-mantine': lazyPreload(function () {
      return import('./index-IipdQWtT.js');
    })
  },
  'upload': {
    'react-mantine': lazyPreload(function () {
      return import('./index-rUsEmoBR.js');
    })
  },
  'multiselect': {
    'react-mantine': lazyPreload(function () {
      return import('./index-_BbGXHle.js');
    })
  },
  'steps': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CBwJ26pI.js');
    })
  },
  'time': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BDqGyTGU.js');
    })
  },
  'hidden': {
    'react-mantine': lazyPreload(function () {
      return import('./index-B_WrNxWy.js');
    })
  }
};
var Forms = {
  'react-mantine': lazyPreload(function () {
    return import('./index-hBeicPUg.js');
  })
};
