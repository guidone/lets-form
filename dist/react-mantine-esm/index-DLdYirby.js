...
var Fields = {
  'input-text': {
    'react-mantine': lazyPreload(function () {
      return import('./index-C411VSZZ.js');
    })
  },
  'input-number': {
    'react-mantine': lazyPreload(function () {
      return import('./index-Dn2t9eZJ.js');
    })
  },
  'textarea': {
    'react-mantine': lazyPreload(function () {
      return import('./index-ICUuCzTp.js');
    })
  },
  'select': {
    'react-mantine': lazyPreload(function () {
      return import('./index-Bgw663QL.js');
    })
  },
  'checkbox': {
    'react-mantine': lazyPreload(function () {
      return import('./index-jGaP1sVf.js');
    })
  },
  'toggle': {
    'react-mantine': lazyPreload(function () {
      return import('./index-Bag180Ol.js');
    })
  },
  'array': {
    'react-mantine': lazyPreload(function () {
      return import('./index-B4lG5S_Q.js');
    })
  },
  'checkbox-group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CQl84PnC.js');
    })
  },
  'radio-group': {
    'react-mantine': lazyPreload(function () {
      return import('./index-sRTTFrxb.js');
    })
  },
  'two-columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BjrQSB1P.js');
    })
  },
  'three-columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-P2X6RfIj.js');
    })
  },
  'columns': {
    'react-mantine': lazyPreload(function () {
      return import('./index-fBKs8SR6.js');
    })
  },
  'group': {
    'react-mantine': lazyPreload(function () {
      return import('./index--2EqpSHG.js');
    })
  },
  'object': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CEYXKouF.js').then(function (n) { return n.i; });
    })
  },
  'date': {
    'react-mantine': lazyPreload(function () {
      return import('./index-m-N5oEAx.js');
    })
  },
  'datetime': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BdvQV1ig.js');
    })
  },
  'rate': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DRO9NbVf.js');
    })
  },
  'placeholder': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DvwT1W8m.js');
    })
  },
  'placeholder-image': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DeGtTbKX.js');
    })
  },
  'divider': {
    'react-mantine': lazyPreload(function () {
  ...
  'slider': {
    'react-mantine': lazyPreload(function () {
      return import('./index-DzIvd3fg.js');
    })
  },
  'input-tag': {
    'react-mantine': lazyPreload(function () {
      return import('./index-C1k6A1PC.js');
    })
  },
  'tabs': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BX6Fjd9O.js');
    })
  },
  'button': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CTS4Pt9h.js');
    })
  },
  'upload': {
    'react-mantine': lazyPreload(function () {
      return import('./index-fjHpBidZ.js');
    })
  },
  'multiselect': {
    'react-mantine': lazyPreload(function () {
      return import('./index-CL5_vgta.js');
    })
  },
  'steps': {
    'react-mantine': lazyPreload(function () {
      return import('./index-BY_psVHl.js');
    })
  },
  'time': {
    'react-mantine': lazyPreload(function () {
      return import('./index-ISzt8F4g.js');
    })
  },
  'hidden': {
    'react-mantine': lazyPreload(function () {
  ...
  'currency': {
    'react-mantine': lazyPreload(function () {
      return import('./index-8aX1vt1d.js');
    })
  }
};
var Forms = {
  'react-mantine': lazyPreload(function () {
    return import('./index-Bxc2uayh.js');
  })
};
