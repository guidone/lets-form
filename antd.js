(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("react"), require("rsuite"), require("rsuite/locales"), require("antd"), require("dayjs"));
	else if(typeof define === 'function' && define.amd)
		define(["react", "rsuite", "rsuite/locales", "antd", "dayjs"], factory);
	else if(typeof exports === 'object')
		exports["lets-form-antd"] = factory(require("react"), require("rsuite"), require("rsuite/locales"), require("antd"), require("dayjs"));
	else
		root["lets-form-antd"] = factory(root["react"], root["rsuite"], root["rsuite/locales"], root["antd"], root["dayjs"]);
})(self, (__WEBPACK_EXTERNAL_MODULE__8156__, __WEBPACK_EXTERNAL_MODULE__1186__, __WEBPACK_EXTERNAL_MODULE__977__, __WEBPACK_EXTERNAL_MODULE__2721__, __WEBPACK_EXTERNAL_MODULE__5760__) => {
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".lf-control-select-option-antd img{width:20px;max-width:20px;max-height:20px;margin-right:6px;margin-top:-2px}", "",{"version":3,"sources":["webpack://./react-antd/select/select.scss"],"names":[],"mappings":"AAEI,mCACE,UAAA,CACA,cAAA,CACA,eAAA,CACA,gBAAA,CACA,eAAA","sourcesContent":["\n  .lf-control-select-option-antd {\n    img {\n      width: 20px;\n      max-width: 20px;\n      max-height: 20px;\n      margin-right: 6px;\n      margin-top: -2px;\n    }\n  }\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
__webpack_require__.d(__webpack_exports__, {
  ...
  "Fields": () => (/* binding */ react_antd_Fields),
  "Forms": () => (/* binding */ react_antd_Forms),
...
var RSuiteGenericDate = function RSuiteGenericDate(_ref) {
  ...
  return /*#__PURE__*/external_react_default().createElement(external_rsuite_.Form.Group, {
    ...
    tooltip: true
  }, hint), required && /*#__PURE__*/external_react_default().createElement(required_icon_RequiredIcon, null)), /*#__PURE__*/external_react_default().createElement(external_rsuite_.CustomProvider, {
...
var FormAntD = function FormAntD(_ref) {
  ...
  return /*#__PURE__*/external_react_default().createElement(external_antd_.Form, {
    className: classnames_default()('lf-form lf-form-react-antd', form_defineProperty({}, buttonsAlign ? "lf-form-buttons-align-".concat(buttonsAlign) : undefined, true)),
...
var input_text_excluded = ["name", "label", "hint", "value", "size", "placeholder", "tooltip", "disabled", "readOnly", "required", "error", "prefix", "postfix", "onChange", "onBlur", "fullWidth", "width", "autocomplete", "inputMode", "inputType", "inside"];
...
var TextInput = I18N(function (_ref) {
  ...
  var inner = /*#__PURE__*/external_react_default().createElement(external_rsuite_.Form.Control, input_text_extends({
    name: name,
  ...
  return /*#__PURE__*/external_react_default().createElement(external_rsuite_.Form.Group, {
    ...
    tooltip: true
  }, hint), required && /*#__PURE__*/external_react_default().createElement(required_icon_RequiredIcon, null)), !needsGroup && inner, needsGroup && /*#__PURE__*/external_react_default().createElement(external_rsuite_.InputGroup, {
    inside: inside
...
var Select = I18N(function (_ref) {
  ...
  return /*#__PURE__*/external_react_default().createElement(external_rsuite_.Form.Group, {
    ...
    tooltip: true
  }, hint), required && /*#__PURE__*/external_react_default().createElement(required_icon_RequiredIcon, null)), /*#__PURE__*/external_react_default().createElement(external_rsuite_.Form.Control, select_extends({
    ...
    cleanable: cleanable
  }, pass_rest_passRest(rest))), hint && !tooltip && /*#__PURE__*/external_react_default().createElement(external_rsuite_.Form.HelpText, null, hint));
}, ['label', 'hint', 'placeholder'], {
...
var SelectDate = I18N(function (_ref) {
  ...
  if (isDate_default()(value)) {
    ...
    if (is_valid_date_isValidDate(d)) {
      currentValue = d;
    }
  }
...
var SliderRsuite = I18N(function (_ref) {
  ...
  return /*#__PURE__*/external_react_default().createElement(external_rsuite_.Form.Group, {
    ...
    tooltip: true
  }, hint), required && /*#__PURE__*/external_react_default().createElement(required_icon_RequiredIcon, null)), /*#__PURE__*/external_react_default().createElement(external_rsuite_.Slider, slider_extends({
...
var Textarea = I18N(function (_ref) {
  ...
  return /*#__PURE__*/external_react_default().createElement(external_rsuite_.Form.Group, {
    ...
    tooltip: true
  }, hint), required && /*#__PURE__*/external_react_default().createElement(required_icon_RequiredIcon, null)), inner, hint && !tooltip && /*#__PURE__*/external_react_default().createElement(external_rsuite_.Form.HelpText, null, hint));
}, ['label', 'hint', 'placeholder']);
...
var PlaceholderRSuite5 = I18N(function (_ref) {
  ...
  return /*#__PURE__*/external_react_default().createElement(external_rsuite_.Form.Group, {
    ...
    tooltip: true
  }, hint), required && /*#__PURE__*/external_react_default().createElement(required_icon_RequiredIcon, null)), /*#__PURE__*/external_react_default().createElement(Placeholder, {
    text: text
  }), hint && !tooltip && /*#__PURE__*/external_react_default().createElement(external_rsuite_.Form.HelpText, null, hint));
}, ['label', 'hint', 'text']);
...
var cjs_js_react_antd_input_text_input_text = __webpack_require__(3877);
...
var input_text_input_text_update = injectStylesIntoStyleTag_default()(cjs_js_react_antd_input_text_input_text/* default */.Z, input_text_input_text_options);




       /* harmony default export */ const react_antd_input_text_input_text = (cjs_js_react_antd_input_text_input_text/* default */.Z && cjs_js_react_antd_input_text_input_text/* default.locals */.Z.locals ? cjs_js_react_antd_input_text_input_text/* default.locals */.Z.locals : undefined);

;// CONCATENATED MODULE: ./react-antd/input-text/index.js
var react_antd_input_text_excluded = ["name", "label", "hint", "value", "size", "placeholder", "showCount", "tooltip", "disabled", "readOnly", "required", "maxLength", "error", "prefix", "postfix", "allowClear", "bordered", "onChange", "onBlur", "fullWidth", "width", "inputType", "inputMode", "autocomplete"];
function react_antd_input_text_extends() { react_antd_input_text_extends = Object.assign ? Object.assign.bind() : function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return react_antd_input_text_extends.apply(this, arguments); }
function react_antd_input_text_objectWithoutProperties(source, excluded) { if (source == null) return {}; var target = react_antd_input_text_objectWithoutPropertiesLoose(source, excluded); var key, i; if (Object.getOwnPropertySymbols) { var sourceSymbolKeys = Object.getOwnPropertySymbols(source); for (i = 0; i < sourceSymbolKeys.length; i++) { key = sourceSymbolKeys[i]; if (excluded.indexOf(key) >= 0) continue; if (!Object.prototype.propertyIsEnumerable.call(source, key)) continue; target[key] = source[key]; } } return target; }
function react_antd_input_text_objectWithoutPropertiesLoose(source, excluded) { if (source == null) return {}; var target = {}; var sourceKeys = Object.keys(source); var key, i; for (i = 0; i < sourceKeys.length; i++) { key = sourceKeys[i]; if (excluded.indexOf(key) >= 0) continue; target[key] = source[key]; } return target; }
...
var input_text_TextInput = I18N(function (_ref) {
  var name = _ref.name,
    ...
    inputMode = _ref.inputMode,
    autocomplete = _ref.autocomplete,
    rest = react_antd_input_text_objectWithoutProperties(_ref, react_antd_input_text_excluded);
  ...
  }, /*#__PURE__*/external_react_default().createElement(external_antd_.Input, react_antd_input_text_extends({
    placeholder: placeholder,
    readOnly: readOnly,
    autocomplete: autocomplete,
...
var Toggle = I18N(function (_ref) {
  ...
  return /*#__PURE__*/external_react_default().createElement(external_antd_.Form.Item, {
    ...
    hasFeedback: error != null,
    validateStatus: error ? 'error' : undefined
  }, /*#__PURE__*/external_react_default().createElement(external_antd_.Switch, {
    defaultChecked: value,
    readOnly: readOnly,
    onChange: handleChange,
    onBlur: onBlur,
...
var react_antd_checkbox_excluded = ["name", "label", "hint", "value", "size", "placeholder", "showCount", "tooltip", "disabled", "readOnly", "required", "maxLength", "error", "prefix", "postfix", "allowClear", "bordered", "onChange", "onBlur", "width", "checkedChildren", "unCheckedChildren"];
function react_antd_checkbox_objectWithoutProperties(source, excluded) { if (source == null) return {}; var target = react_antd_checkbox_objectWithoutPropertiesLoose(source, excluded); var key, i; if (Object.getOwnPropertySymbols) { var sourceSymbolKeys = Object.getOwnPropertySymbols(source); for (i = 0; i < sourceSymbolKeys.length; i++) { key = sourceSymbolKeys[i]; if (excluded.indexOf(key) >= 0) continue; if (!Object.prototype.propertyIsEnumerable.call(source, key)) continue; target[key] = source[key]; } } return target; }
function react_antd_checkbox_objectWithoutPropertiesLoose(source, excluded) { if (source == null) return {}; var target = {}; var sourceKeys = Object.keys(source); var key, i; for (i = 0; i < sourceKeys.length; i++) { key = sourceKeys[i]; if (excluded.indexOf(key) >= 0) continue; target[key] = source[key]; } return target; }
...
var CheckboxAntd = I18N(function (_ref) {
  var name = _ref.name,
    ...
    checkedChildren = _ref.checkedChildren,
    unCheckedChildren = _ref.unCheckedChildren,
    rest = react_antd_checkbox_objectWithoutProperties(_ref, react_antd_checkbox_excluded);
  var handleChange = (0,external_react_.useCallback)(function (e) {
    return onChange(e.target.checked);
  }, [onChange]);
  return /*#__PURE__*/external_react_default().createElement(external_antd_.Form.Item, {
...
var uk = __webpack_require__(4685);
...
var react_antd_date_excluded = ["name", "label", "hint", "value", "size", "placeholder", "showCount", "tooltip", "disabled", "readOnly", "required", "maxLength", "error", "prefix", "postfix", "allowClear", "bordered", "onChange", "onBlur", "width", "placement", "format", "showNow", "showToday", "picker", "mode", "lfLocale"];
function react_antd_date_extends() { react_antd_date_extends = Object.assign ? Object.assign.bind() : function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return react_antd_date_extends.apply(this, arguments); }
function react_antd_date_objectWithoutProperties(source, excluded) { if (source == null) return {}; var target = react_antd_date_objectWithoutPropertiesLoose(source, excluded); var key, i; if (Object.getOwnPropertySymbols) { var sourceSymbolKeys = Object.getOwnPropertySymbols(source); for (i = 0; i < sourceSymbolKeys.length; i++) { key = sourceSymbolKeys[i]; if (excluded.indexOf(key) >= 0) continue; if (!Object.prototype.propertyIsEnumerable.call(source, key)) continue; target[key] = source[key]; } } return target; }
function react_antd_date_objectWithoutPropertiesLoose(source, excluded) { if (source == null) return {}; var target = {}; var sourceKeys = Object.keys(source); var key, i; for (i = 0; i < sourceKeys.length; i++) { key = sourceKeys[i]; if (excluded.indexOf(key) >= 0) continue; target[key] = source[key]; } return target; }
...
var DateAntd = I18N(function (_ref) {
  var name = _ref.name,
    ...
    mode = _ref.mode,
    lfLocale = _ref.lfLocale,
    rest = react_antd_date_objectWithoutProperties(_ref, react_antd_date_excluded);
  var _useFormContext = hooks_useFormContext(),
  ...
  return /*#__PURE__*/external_react_default().createElement(external_antd_.Form.Item, {
    ...
    hasFeedback: error != null,
    validateStatus: error ? 'error' : undefined
  }, /*#__PURE__*/external_react_default().createElement(external_antd_.DatePicker, react_antd_date_extends({
...
var cjs_js_react_antd_select_select = __webpack_require__(4016);
...
var select_select_options = {};

select_select_options.styleTagTransform = (styleTagTransform_default());
select_select_options.setAttributes = (setAttributesWithoutAttributes_default());

      select_select_options.insert = insertBySelector_default().bind(null, "head");
    
select_select_options.domAPI = (styleDomAPI_default());
select_select_options.insertStyleElement = (insertStyleElement_default());

var select_select_update = injectStylesIntoStyleTag_default()(cjs_js_react_antd_select_select/* default */.Z, select_select_options);




       /* harmony default export */ const react_antd_select_select = (cjs_js_react_antd_select_select/* default */.Z && cjs_js_react_antd_select_select/* default.locals */.Z.locals ? cjs_js_react_antd_select_select/* default.locals */.Z.locals : undefined);

;// CONCATENATED MODULE: ./react-antd/select/index.js
function react_antd_select_typeof(obj) { "@babel/helpers - typeof"; return react_antd_select_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, react_antd_select_typeof(obj); }

var react_antd_select_excluded = ["name", "label", "hint", "value", "size", "placeholder", "showCount", "tooltip", "disabled", "readOnly", "required", "maxLength", "error", "prefix", "postfix", "allowClear", "bordered", "onChange", "onBlur", "width", "showSearch", "placement", "showArrow", "listHeight", "virtual", "options", "filterKey", "filterValue", "showImageOptions"];
function react_antd_select_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function react_antd_select_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? react_antd_select_ownKeys(Object(source), !0).forEach(function (key) { react_antd_select_defineProperty(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : react_antd_select_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
function react_antd_select_defineProperty(obj, key, value) { key = react_antd_select_toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function react_antd_select_toPropertyKey(arg) { var key = react_antd_select_toPrimitive(arg, "string"); return react_antd_select_typeof(key) === "symbol" ? key : String(key); }
function react_antd_select_toPrimitive(input, hint) { if (react_antd_select_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (react_antd_select_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
function react_antd_select_extends() { react_antd_select_extends = Object.assign ? Object.assign.bind() : function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return react_antd_select_extends.apply(this, arguments); }
function react_antd_select_objectWithoutProperties(source, excluded) { if (source == null) return {}; var target = react_antd_select_objectWithoutPropertiesLoose(source, excluded); var key, i; if (Object.getOwnPropertySymbols) { var sourceSymbolKeys = Object.getOwnPropertySymbols(source); for (i = 0; i < sourceSymbolKeys.length; i++) { key = sourceSymbolKeys[i]; if (excluded.indexOf(key) >= 0) continue; if (!Object.prototype.propertyIsEnumerable.call(source, key)) continue; target[key] = source[key]; } } return target; }
function react_antd_select_objectWithoutPropertiesLoose(source, excluded) { if (source == null) return {}; var target = {}; var sourceKeys = Object.keys(source); var key, i; for (i = 0; i < sourceKeys.length; i++) { key = sourceKeys[i]; if (excluded.indexOf(key) >= 0) continue; target[key] = source[key]; } return target; }
...
var SelectAntd = I18N(function (_ref) {
  var name = _ref.name,
    ...
    rest = react_antd_select_objectWithoutProperties(_ref, react_antd_select_excluded);
  return /*#__PURE__*/external_react_default().createElement(external_antd_.Form.Item, {
    "data-lf-field-name": name,
    ...
    hasFeedback: error != null,
    validateStatus: error ? 'error' : undefined
  }, /*#__PURE__*/external_react_default().createElement(external_antd_.Select, react_antd_select_extends({
    placeholder: placeholder,
    readOnly: readOnly,
    onChange: onChange,
    onBlur: onBlur,
  ...
  }, pass_rest_passRest(rest)), (filterOptions(options, filterValue, filterKey) || []).map(function (option) {
  ...
  options: function options(value, i18n) {
    return (value !== null && value !== void 0 ? value : []).map(function (value) {
      return react_antd_select_objectSpread(react_antd_select_objectSpread({}, value), {}, {
        label: i18n(value.label)
      });
    });
  }
...
function react_antd_radio_group_typeof(obj) { "@babel/helpers - typeof"; return react_antd_radio_group_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, react_antd_radio_group_typeof(obj); }

var react_antd_radio_group_excluded = ["name", "label", "hint", "value", "size", "placeholder", "showCount", "tooltip", "disabled", "readOnly", "required", "options", "maxLength", "inline", "error", "prefix", "postfix", "allowClear", "bordered", "onChange", "onBlur", "width", "optionType"];
function react_antd_radio_group_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function react_antd_radio_group_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? react_antd_radio_group_ownKeys(Object(source), !0).forEach(function (key) { react_antd_radio_group_defineProperty(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : react_antd_radio_group_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
function react_antd_radio_group_defineProperty(obj, key, value) { key = react_antd_radio_group_toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function react_antd_radio_group_toPropertyKey(arg) { var key = react_antd_radio_group_toPrimitive(arg, "string"); return react_antd_radio_group_typeof(key) === "symbol" ? key : String(key); }
function react_antd_radio_group_toPrimitive(input, hint) { if (react_antd_radio_group_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (react_antd_radio_group_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
function react_antd_radio_group_extends() { react_antd_radio_group_extends = Object.assign ? Object.assign.bind() : function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return react_antd_radio_group_extends.apply(this, arguments); }
function react_antd_radio_group_objectWithoutProperties(source, excluded) { if (source == null) return {}; var target = react_antd_radio_group_objectWithoutPropertiesLoose(source, excluded); var key, i; if (Object.getOwnPropertySymbols) { var sourceSymbolKeys = Object.getOwnPropertySymbols(source); for (i = 0; i < sourceSymbolKeys.length; i++) { key = sourceSymbolKeys[i]; if (excluded.indexOf(key) >= 0) continue; if (!Object.prototype.propertyIsEnumerable.call(source, key)) continue; target[key] = source[key]; } } return target; }
function react_antd_radio_group_objectWithoutPropertiesLoose(source, excluded) { if (source == null) return {}; var target = {}; var sourceKeys = Object.keys(source); var key, i; for (i = 0; i < sourceKeys.length; i++) { key = sourceKeys[i]; if (excluded.indexOf(key) >= 0) continue; target[key] = source[key]; } return target; }
...
var RadioGroup = I18N(function (_ref) {
  var name = _ref.name,
    ...
    rest = react_antd_radio_group_objectWithoutProperties(_ref, react_antd_radio_group_excluded);
  var handleChange = (0,external_react_.useCallback)(function (e) {
    return onChange(e.target.value);
  }, [onChange]);
  var ctrl;
  if (inline) {
    ctrl = /*#__PURE__*/external_react_default().createElement(external_antd_.Radio.Group, react_antd_radio_group_extends({
      onChange: handleChange,
      defaultValue: value,
      disabled: disabled,
      readOnly: readOnly,
  ...
  options: function options(value, i18n) {
    return (value !== null && value !== void 0 ? value : []).map(function (value) {
      return react_antd_radio_group_objectSpread(react_antd_radio_group_objectSpread({}, value), {}, {
        label: i18n(value.label)
      });
    });
  }
...
var input_number_excluded = ["name", "label", "hint", "value", "size", "placeholder", "showCount", "tooltip", "disabled", "readOnly", "required", "maxLength", "error", "prefix", "postfix", "allowClear", "bordered", "onChange", "onBlur", "width", "showControl", "min", "max", "step"];
...
var textarea_excluded = ["name", "label", "hint", "value", "size", "placeholder", "showCount", "tooltip", "disabled", "readOnly", "required", "maxLength", "error", "allowClear", "bordered", "onChange", "onBlur", "width"];
function react_antd_textarea_extends() { react_antd_textarea_extends = Object.assign ? Object.assign.bind() : function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return react_antd_textarea_extends.apply(this, arguments); }
...
var TextareaAntd = I18N(function (_ref) {
  ...
  return /*#__PURE__*/external_react_default().createElement(external_antd_.Form.Item, {
    ...
    hasFeedback: error != null,
    validateStatus: error ? 'error' : undefined
  }, /*#__PURE__*/external_react_default().createElement(external_antd_.Input.TextArea, react_antd_textarea_extends({
    placeholder: placeholder,
    readOnly: readOnly,
    onChange: handleChange,
    onBlur: onBlur,
...
var multiselect_Multiselect = I18N(function (_ref) {
  var name = _ref.name,
    label = _ref.label,
    hint = _ref.hint,
    value = _ref.value,
...
function react_antd_slider_typeof(obj) { "@babel/helpers - typeof"; return react_antd_slider_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, react_antd_slider_typeof(obj); }


var react_antd_slider_excluded = ["name", "label", "hint", "value", "size", "placeholder", "showCount", "tooltip", "disabled", "readOnly", "required", "keyboard", "dots", "min", "max", "step", "reverse", "tooltipOpen", "tooltipPlacement", "error", "onChange", "onBlur", "width", "marks", "included"];
function react_antd_slider_extends() { react_antd_slider_extends = Object.assign ? Object.assign.bind() : function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return react_antd_slider_extends.apply(this, arguments); }
function react_antd_slider_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function react_antd_slider_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? react_antd_slider_ownKeys(Object(source), !0).forEach(function (key) { react_antd_slider_defineProperty(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : react_antd_slider_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
function react_antd_slider_defineProperty(obj, key, value) { key = react_antd_slider_toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function react_antd_slider_toPropertyKey(arg) { var key = react_antd_slider_toPrimitive(arg, "string"); return react_antd_slider_typeof(key) === "symbol" ? key : String(key); }
function react_antd_slider_toPrimitive(input, hint) { if (react_antd_slider_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (react_antd_slider_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
function react_antd_slider_objectWithoutProperties(source, excluded) { if (source == null) return {}; var target = react_antd_slider_objectWithoutPropertiesLoose(source, excluded); var key, i; if (Object.getOwnPropertySymbols) { var sourceSymbolKeys = Object.getOwnPropertySymbols(source); for (i = 0; i < sourceSymbolKeys.length; i++) { key = sourceSymbolKeys[i]; if (excluded.indexOf(key) >= 0) continue; if (!Object.prototype.propertyIsEnumerable.call(source, key)) continue; target[key] = source[key]; } } return target; }
function react_antd_slider_objectWithoutPropertiesLoose(source, excluded) { if (source == null) return {}; var target = {}; var sourceKeys = Object.keys(source); var key, i; for (i = 0; i < sourceKeys.length; i++) { key = sourceKeys[i]; if (excluded.indexOf(key) >= 0) continue; target[key] = source[key]; } return target; }
...
var SliderAnt = I18N(function (_ref) {
  var name = _ref.name,
    ...
    rest = react_antd_slider_objectWithoutProperties(_ref, react_antd_slider_excluded);
  var antdMarks = undefined;
  if (isArray_default()(marks) && !isEmpty_default()(marks)) {
    antdMarks = marks.reduce(function (accumulator, value) {
      return react_antd_slider_objectSpread(react_antd_slider_objectSpread({}, accumulator), {}, react_antd_slider_defineProperty({}, value.value, value.label));
    }, {});
  }
  return /*#__PURE__*/external_react_default().createElement(external_antd_.Form.Item, {
    "data-lf-field-name": name,
    ...
    hasFeedback: error != null,
    validateStatus: error ? 'error' : undefined
  }, /*#__PURE__*/external_react_default().createElement(external_antd_.Slider, react_antd_slider_extends({
    readOnly: readOnly,
    included: included,
    onChange: onChange,
    onBlur: onBlur,
  ...
  marks: function marks(value, i18n) {
    return value.map(function (value) {
      return react_antd_slider_objectSpread(react_antd_slider_objectSpread({}, value), {}, {
        label: i18n(value.label)
      });
    });
  }
...
var react_antd_Fields = {
  'text-input': {
    'react-antd': input_text_TextInput
  },
  'toggle': {
    'react-antd': Toggle
  },
  ...
  'multiselect': {
    'react-antd': multiselect_Multiselect
  },
  'three-columns': {
...
var react_antd_Forms = {
  'react-antd': FormAntD
};
var react_antd_FormGenerator = GenerateGenerator({
  Fields: react_antd_Fields,
  Forms: react_antd_Forms
});
var react_antd_LetsForm = function LetsForm(_ref) {
  var framework = _ref.framework,
    children = _ref.children,
    rest = react_antd_objectWithoutProperties(_ref, react_antd_excluded);
  return /*#__PURE__*/external_react_default().createElement(react_antd_FormGenerator, react_antd_extends({
    framework: "react-antd"
  }, rest), children);
};
/* harmony default export */ const react_antd = (react_antd_LetsForm);
