...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".lf-control-input-text .lf-prefix-icon{max-height:16px}.lf-control-input-text.lf-size-small .lf-prefix-icon{max-height:12px}.lf-control-input-text.lf-size-large .lf-prefix-icon{max-height:18px}", "",{"version":3,"sources":["webpack://./react-antd/input-text/input-text.scss"],"names":[],"mappings":"AAEE,uCACE,eAAA,CAIA,qDACE,eAAA,CAKF,qDACE,eAAA","sourcesContent":[".lf-control-input-text {\n\n  .lf-prefix-icon {\n    max-height: 16px;\n  }\n\n  &.lf-size-small {\n    .lf-prefix-icon {\n      max-height: 12px;\n    }\n  }\n\n  &.lf-size-large {\n    .lf-prefix-icon {\n      max-height: 18px;\n    }\n  }\n}"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
