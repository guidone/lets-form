...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".lf-control-steps .lf-step{margin-top:var(--lf-field-margin);margin-bottom:var(--lf-field-margin)}", "",{"version":3,"sources":["webpack://./react-rsuite5/steps/steps.scss"],"names":[],"mappings":"AACE,2BACE,iCAAA,CACA,oCAAA","sourcesContent":[".lf-control-steps {\n  .lf-step {\n    margin-top: var(--lf-field-margin);\n    margin-bottom: var(--lf-field-margin);\n  }\n}"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var RSuiteButton = function RSuiteButton(_ref) {
  ...
  if (!isEmpty_default()(label) && !isEmpty_default()(icon)) {
    ...
    inner = /*#__PURE__*/external_react_default().createElement(external_rsuite_.Button, rest, label);
  } else if (isEmpty_default()(label) && !isEmpty_default()(icon)) {
...
var steps_update = injectStylesIntoStyleTag_default()(steps/* default */.Z, steps_options);
       ...
       /* harmony default export */ const steps_steps = (steps/* default */.Z && steps/* default.locals */.Z.locals ? steps/* default.locals */.Z.locals : undefined);

;// CONCATENATED MODULE: ./react-rsuite5/steps/index.js


var steps_excluded = ["name", "children", "value", "steps", "onChange", "small", "labelNext", "labelPrevious"];
...
var Rsuite5Steps = (0,components/* I18N */.mb)(function (_ref) {
  ...
  var step = !isEmpty_default()(steps) ? steps[stepIdx].value : null;
  ...
  return /*#__PURE__*/external_react_default().createElement("div", {
    ...
    className: "lf-step"
  }, children(step)), /*#__PURE__*/external_react_default().createElement(external_rsuite_.ButtonGroup, null, /*#__PURE__*/external_react_default().createElement(external_rsuite_.Button, {
